...
<title>mycsg SASnR2 1800_Merging-datasets</title>
...
<li class="nav-item dropdown d-flex align-items-center">
  ...
  <div class="dropdown-menu dropdown-menu-end dropdown-menu-right p-2"
       ...
       style="min-width: 320px; max-width: min(92vw, 420px); overflow-wrap:anywhere;">
        ...
        <div class="px-1 text-muted" style="font-size:.75rem;">As of 17 May 2026, 23:50 IST</div>
      </div>
    </li>  
      <li class="nav-item">
...
</script><div class='csg-adwrap' id='sasnr-lesson-wrap'><div class='csg-center-col'><center><h2>Merging datasets</h2></center><hr><div class="card mb-3 code-card lang-default">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-default" data-toggle="collapse" data-target="#lessonDesc" style="cursor:pointer;" role="button" aria-expanded="true" aria-controls="lessonDesc">    <h6 class="mb-0">Lesson Description</h6>    <span class="toggle-indicator" data-target="lessonDesc">-</span>  </div>  <div id="lessonDesc" class="collapse show">    <div class="card-body variant-description"><ul>
<li>Merging datasets means joining columns &mdash; taking two tables that share a key (like USUBJID) and producing a wider table with columns from both sides.</li>
<li>This is how we bring together DM + VS (demographics plus vital signs), or ADSL + ADLB (subject-level plus lab-level data).</li>
<li>SAS does this with a DATA step using <code>MERGE</code> + <code>BY</code>. Tidyverse offers a family of <code>*_join()</code> functions (<code>left_join</code>, <code>inner_join</code>, <code>full_join</code>). Base R uses <code>merge()</code>.</li>
<li>This lesson performs a one-to-one merge on USUBJID between two small datasets, producing a combined dataset with the columns of both.</li>
<li>After running, each subject has one row with demographic columns from the first input and the extra columns from the second.</li>
</ul>    </div>  </div></div><div id="codeAccordion" class="mb-4"><div class="card mb-2 code-card lang-sas">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-sas" data-toggle="collapse" data-target="#collapse0" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse0">    <h6 class="mb-0"><span class="badge badge-primary mr-2">SAS</span> (Base SAS)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse0">Copy</button>      <span class="toggle-indicator" data-target="collapse0">+</span>    </div>  </div>  <div id="collapse0" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse0"><div style="font-family: Courier New; font-size: 13pt">
<b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> SEX;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">infile</span> <span style="color:#0000ff;background-color:#ffffff;">datalines</span> <span style="color:#0000ff;background-color:#ffffff;">dlm</span><span style="color:#000000;background-color:#ffffff;">=</span><span style="color:#800080;background-color:#ffffff;">'|'</span> <span style="color:#0000ff;background-color:#ffffff;">dsd</span> <span style="color:#0000ff;background-color:#ffffff;">missover</span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#0000ff;background-color:#ffffff;">input</span><span style="color:#000000;background-color:#ffffff;"> Name : </span><span style="color:#08726d;background-color:#ffffff;">$8.</span><span style="color:#000000;background-color:#ffffff;"> Sex : </span><span style="color:#08726d;background-color:#ffffff;">$1.</span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#0000ff;background-color:#ffffff;">label</span><span style="color:#000000;background-color:#ffffff;"> ;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">format</span><span style="color:#000000;background-color:#ffffff;"> ;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">datalines4</span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#89632b;background-color:#ffffc0;">Alfred|M<br>Henry|M<br>Mary|F<br></span><span style="color:#000000;background-color:#ffffff;">;;;;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> AHW;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">infile</span> <span style="color:#0000ff;background-color:#ffffff;">datalines</span> <span style="color:#0000ff;background-color:#ffffff;">dlm</span><span style="color:#000000;background-color:#ffffff;">=</span><span style="color:#800080;background-color:#ffffff;">'|'</span> <span style="color:#0000ff;background-color:#ffffff;">dsd</span> <span style="color:#0000ff;background-color:#ffffff;">missover</span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#0000ff;background-color:#ffffff;">input</span><span style="color:#000000;background-color:#ffffff;"> Name : </span><span style="color:#08726d;background-color:#ffffff;">$8.</span><span style="color:#000000;background-color:#ffffff;"> Age : </span><span style="color:#08726d;background-color:#ffffff;">best32.</span><span style="color:#000000;background-color:#ffffff;"> Height : </span><span style="color:#08726d;background-color:#ffffff;">best32.</span><span style="color:#000000;background-color:#ffffff;"> Weight : </span><span style="color:#08726d;background-color:#ffffff;">best32.</span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#0000ff;background-color:#ffffff;">label</span><span style="color:#000000;background-color:#ffffff;"> ;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">format</span><span style="color:#000000;background-color:#ffffff;"> ;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">datalines4</span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#89632b;background-color:#ffffc0;">Alfred|14|69|112.5<br>Henry|14|63.5|102.5<br>James|12|57.3|83<br></span><span style="color:#000000;background-color:#ffffff;">;;;;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*full join;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br><br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> full;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">merge</span><span style="color:#000000;background-color:#ffffff;"> sex ahw;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">by</span><span style="color:#000000;background-color:#ffffff;"> name;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*left join;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br><br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> left;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">merge</span><span style="color:#000000;background-color:#ffffff;"> sex(</span><span style="color:#0000ff;background-color:#ffffff;">in</span><span style="color:#000000;background-color:#ffffff;">=a) ahw;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">by</span><span style="color:#000000;background-color:#ffffff;"> name;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">if</span><span style="color:#000000;background-color:#ffffff;"> a ;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*right join;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br><br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> right;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">merge</span><span style="color:#000000;background-color:#ffffff;"> sex ahw(</span><span style="color:#0000ff;background-color:#ffffff;">in</span><span style="color:#000000;background-color:#ffffff;">=b);<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">by</span><span style="color:#000000;background-color:#ffffff;"> name;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">if</span><span style="color:#000000;background-color:#ffffff;"> b ;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*inner join;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br><br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> inner;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">merge</span><span style="color:#000000;background-color:#ffffff;"> sex(</span><span style="color:#0000ff;background-color:#ffffff;">in</span><span style="color:#000000;background-color:#ffffff;">=a) ahw(</span><span style="color:#0000ff;background-color:#ffffff;">in</span><span style="color:#000000;background-color:#ffffff;">=b);<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">by</span><span style="color:#000000;background-color:#ffffff;"> name;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">if</span><span style="color:#000000;background-color:#ffffff;"> a </span><span style="color:#0000ff;background-color:#ffffff;">and</span><span style="color:#000000;background-color:#ffffff;"> b;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b><span style="color:#000000;background-color:#ffffff;">;</span></div>      </div><div class="variant-description mt-2"><ul>
<li>To merge two datasets in SAS, we sort each one by the key variable and then use a DATA step with <code>MERGE</code> + <code>BY</code>.</li>
<li><code>proc sort data=class; by Name; run;</code> sorts each input on the merge key &mdash; SAS requires sorted input for a BY merge.</li>
<li>In the DATA step, <code>merge class class2; by Name;</code> interleaves rows by matching Name values across the inputs.</li>
<li>For matched Name values, SAS writes one combined row with columns from both sides. For Name values in only one input, SAS still writes a row but with missing values for the absent side&rsquo;s columns (the equivalent of a full outer join).</li>
<li>The default SAS merge is full-outer. To mimic an inner join, we add <code>if in_a and in_b;</code> using the <code>in=</code> dataset options to mark membership.</li>
...
inner&lt;-inner_join(sex,ahw,by=&quot;Name&quot;)</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>In tidyverse, we reach for the join family in dplyr: <code>left_join</code>, <code>inner_join</code>, <code>right_join</code>, <code>full_join</code>.</li>
<li><code>left_join(class, class2, by = "Name")</code> keeps every row of <code>class</code> and adds matching columns from <code>class2</code>. Non-matching rows get <code>NA</code> for the right-side columns.</li>
<li><code>inner_join</code> keeps only rows that match in both inputs. <code>full_join</code> keeps every row from either side (equivalent to the default SAS merge).</li>
<li>No sort step is needed &mdash; dplyr joins handle unsorted input internally.</li>
<li>The <code>by =</code> argument takes one or more column names. For multi-key joins we pass a vector: <code>by = c("Name", "Visit")</code>.</li>
</ul></div>    </div>  </div></div><div class="card mb-2 code-card lang-r-base">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-r-base" data-toggle="collapse" data-target="#collapse2" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse2">    <h6 class="mb-0"><span class="badge badge-success mr-2">R</span> (base)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse2">Copy</button>      <span class="toggle-indicator" data-target="collapse2">+</span>    </div>  </div>  <div id="collapse2" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse2"><pre><code class="language-r">sex &lt;- data.frame(
  Name = c(&quot;Alfred&quot;, &quot;Henry&quot;, &quot;Mary&quot;),
  Sex = c(&quot;M&quot;, &quot;M&quot;, &quot;F&quot;)
  , stringsAsFactors = FALSE
)

ahw &lt;- data.frame(
  Name = c(&quot;Alfred&quot;, &quot;Henry&quot;, &quot;James&quot;),
  Age = c(14, 14, 12),
  Height = c(69, 63.5, 57.3),
  Weight = c(112.5, 102.5, 83)
  , stringsAsFactors = FALSE
)

full &lt;- merge(sex, ahw, by = &quot;Name&quot;, all = TRUE)

left &lt;- merge(sex, ahw, by = &quot;Name&quot;, all.x = TRUE)

right &lt;- merge(sex, ahw, by = &quot;Name&quot;, all.y = TRUE)

inner &lt;- merge(sex, ahw, by = &quot;Name&quot;)</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>In base R, we join with <code>merge(x, y, by = "Name")</code>.</li>
<li>By default, <code>merge()</code> performs an inner join &mdash; it keeps only rows whose key value appears in both inputs.</li>
<li>To change that, we use <code>all = TRUE</code> (full outer), <code>all.x = TRUE</code> (left join) or <code>all.y = TRUE</code> (right join).</li>
<li>Multi-key merges pass a vector to <code>by</code>: <code>merge(df1, df2, by = c("Name", "Visit"))</code>.</li>
<li>Like dplyr, <code>merge()</code> handles unsorted input. Unlike the SAS BY merge, we never have to pre-sort.</li>
</ul></div>    </div>  </div></div></div></div></div><script>
    const variants = [{"label":"SAS (Base SAS)","code":"\ndata\u00a0SEX;\ninfile\u00a0datalines\u00a0dlm='|'\u00a0dsd\u00a0missover;\ninput\u00a0Name\u00a0:\u00a0$8.\u00a0Sex\u00a0:\u00a0$1.;\nlabel\u00a0;\nformat\u00a0;\ndatalines4;\nAlfred|MHenry|MMary|F;;;;\nrun;\ndata\u00a0AHW;\ninfile\u00a0datalines\u00a0dlm='|'\u00a0dsd\u00a0missover;\ninput\u00a0Name\u00a0:\u00a0$8.\u00a0Age\u00a0:\u00a0best32.\u00a0Height\u00a0:\u00a0best32.\u00a0Weight\u00a0:\u00a0best32.;\nlabel\u00a0;\nformat\u00a0;\ndatalines4;\nAlfred|14|69|112.5Henry|14|63.5|102.5James|12|57.3|83;;;;\nrun;\n*------------------------------------------------------------------------------;*full\u00a0join;*------------------------------------------------------------------------------;data\u00a0full;\n\u00a0\u00a0\u00a0\u00a0merge\u00a0sex\u00a0ahw;\n\u00a0\u00a0\u00a0\u00a0by\u00a0name;\nrun;\n*------------------------------------------------------------------------------;*left\u00a0join;*------------------------------------------------------------------------------;data\u00a0left;\n\u00a0\u00a0\u00a0\u00a0merge\u00a0sex(in=a)\u00a0ahw;\n\u00a0\u00a0\u00a0\u00a0by\u00a0name;\n\u00a0\u00a0\u00a0\u00a0if\u00a0a\u00a0;\nrun;\n*------------------------------------------------------------------------------;*right\u00a0join;*------------------------------------------------------------------------------;data\u00a0right;\n\u00a0\u00a0\u00a0\u00a0merge\u00a0sex\u00a0ahw(in=b);\n\u00a0\u00a0\u00a0\u00a0by\u00a0name;\n\u00a0\u00a0\u00a0\u00a0if\u00a0b\u00a0;\nrun;\n*------------------------------------------------------------------------------;*inner\u00a0join;*------------------------------------------------------------------------------;data\u00a0inner;\n\u00a0\u00a0\u00a0\u00a0merge\u00a0sex(in=a)\u00a0ahw(in=b);\n\u00a0\u00a0\u00a0\u00a0by\u00a0name;\n\u00a0\u00a0\u00a0\u00a0if\u00a0a\u00a0and\u00a0b;\nrun;","language":"sas","html":"<div style=\"font-family: Courier New; font-size: 13pt\">\n<b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0SEX;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">infile<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">datalines<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dlm<\/span><span style=\"color:#000000;background-color:#ffffff;\">=<\/span><span style=\"color:#800080;background-color:#ffffff;\">'|'<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dsd<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">missover<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">input<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Name\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">$8.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Sex\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">$1.<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">label<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">format<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">datalines4<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#89632b;background-color:#ffffc0;\">Alfred|M<br>Henry|M<br>Mary|F<br><\/span><span style=\"color:#000000;background-color:#ffffff;\">;;;;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0AHW;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">infile<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">datalines<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dlm<\/span><span style=\"color:#000000;background-color:#ffffff;\">=<\/span><span style=\"color:#800080;background-color:#ffffff;\">'|'<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dsd<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">missover<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">input<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Name\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">$8.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Age\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Height\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Weight\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">label<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">format<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">datalines4<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#89632b;background-color:#ffffc0;\">Alfred|14|69|112.5<br>Henry|14|63.5|102.5<br>James|12|57.3|83<br><\/span><span style=\"color:#000000;background-color:#ffffff;\">;;;;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*full\u00a0join;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0full;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">merge<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0sex\u00a0ahw;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">by<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0name;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*left\u00a0join;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0left;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">merge<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0sex(<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">in<\/span><span style=\"color:#000000;background-color:#ffffff;\">=a)\u00a0ahw;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">by<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0name;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">if<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0a\u00a0;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*right\u00a0join;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0right;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">merge<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0sex\u00a0ahw(<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">in<\/span><span style=\"color:#000000;background-color:#ffffff;\">=b);<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">by<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0name;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">if<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0b\u00a0;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*inner\u00a0join;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0inner;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">merge<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0sex(<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">in<\/span><span style=\"color:#000000;background-color:#ffffff;\">=a)\u00a0ahw(<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">in<\/span><span style=\"color:#000000;background-color:#ffffff;\">=b);<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">by<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0name;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">if<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0a\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">and<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0b;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">;<\/span><\/div>"},{"label":"R (tidyverse)","code":"library(tidyverse)\n\nsex<-tribble(\n~Name,~Sex,\n\"Alfred\",\"M\",\n\"Henry\",\"M\",\n\"Mary\",\"F\",\n)\n\nahw<-tribble(\n~Name,~Age,~Height,~Weight,\n\"Alfred\",14,69,112.5,\n\"Henry\",14,63.5,102.5,\n\"James\",12,57.3,83,\n)\n\nfull<-full_join(sex,ahw,by=\"Name\")\n\nleft<-left_join(sex,ahw,by=\"Name\")\n\nright<-right_join(sex,ahw,by=\"Name\")\n\ninner<-inner_join(sex,ahw,by=\"Name\")","language":"r","html":"<pre><code class=\"language-r\">library(tidyverse)\n\nsex&lt;-tribble(\n~Name,~Sex,\n&quot;Alfred&quot;,&quot;M&quot;,\n&quot;Henry&quot;,&quot;M&quot;,\n&quot;Mary&quot;,&quot;F&quot;,\n)\n\nahw&lt;-tribble(\n~Name,~Age,~Height,~Weight,\n&quot;Alfred&quot;,14,69,112.5,\n&quot;Henry&quot;,14,63.5,102.5,\n&quot;James&quot;,12,57.3,83,\n)\n\nfull&lt;-full_join(sex,ahw,by=&quot;Name&quot;)\n\nleft&lt;-left_join(sex,ahw,by=&quot;Name&quot;)\n\nright&lt;-right_join(sex,ahw,by=&quot;Name&quot;)\n\ninner&lt;-inner_join(sex,ahw,by=&quot;Name&quot;)<\/code><\/pre>"},{"label":"R (base)","code":"sex <- data.frame(\n  Name = c(\"Alfred\", \"Henry\", \"Mary\"),\n  Sex = c(\"M\", \"M\", \"F\")\n  , stringsAsFactors = FALSE\n)\n\nahw <- data.frame(\n  Name = c(\"Alfred\", \"Henry\", \"James\"),\n  Age = c(14, 14, 12),\n  Height = c(69, 63.5, 57.3),\n  Weight = c(112.5, 102.5, 83)\n  , stringsAsFactors = FALSE\n)\n\nfull <- merge(sex, ahw, by = \"Name\", all = TRUE)\n\nleft <- merge(sex, ahw, by = \"Name\", all.x = TRUE)\n\nright <- merge(sex, ahw, by = \"Name\", all.y = TRUE)\n\ninner <- merge(sex, ahw, by = \"Name\")","language":"r","html":"<pre><code class=\"language-r\">sex &lt;- data.frame(\n  Name = c(&quot;Alfred&quot;, &quot;Henry&quot;, &quot;Mary&quot;),\n  Sex = c(&quot;M&quot;, &quot;M&quot;, &quot;F&quot;)\n  , stringsAsFactors = FALSE\n)\n\nahw &lt;- data.frame(\n  Name = c(&quot;Alfred&quot;, &quot;Henry&quot;, &quot;James&quot;),\n  Age = c(14, 14, 12),\n  Height = c(69, 63.5, 57.3),\n  Weight = c(112.5, 102.5, 83)\n  , stringsAsFactors = FALSE\n)\n\nfull &lt;- merge(sex, ahw, by = &quot;Name&quot;, all = TRUE)\n\nleft &lt;- merge(sex, ahw, by = &quot;Name&quot;, all.x = TRUE)\n\nright &lt;- merge(sex, ahw, by = &quot;Name&quot;, all.y = TRUE)\n\ninner &lt;- merge(sex, ahw, by = &quot;Name&quot;)<\/code><\/pre>"}] || [];
