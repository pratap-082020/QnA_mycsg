...
<title>mycsg SASnR2 1850_Merging-datasets--select-unmatched-records</title>
...
</script><div class='csg-adwrap' id='sasnr-lesson-wrap'><div class='csg-center-col'><center><h2>Merging datasets- select unmatched records</h2></center><hr><div class="card mb-3 code-card lang-default">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-default" data-toggle="collapse" data-target="#lessonDesc" style="cursor:pointer;" role="button" aria-expanded="true" aria-controls="lessonDesc">    <h6 class="mb-0">Lesson Description</h6>    <span class="toggle-indicator" data-target="lessonDesc">-</span>  </div>  <div id="lessonDesc" class="collapse show">    <div class="card-body variant-description"><ul>
<li>Sometimes we do not want the matched rows from a merge &mdash; we want the mismatches. For example, which subjects in the demographics file have no record in the vitals file, or vice versa.</li>
<li>SAS flags this by combining MERGE with the <code>in=</code> dataset option and an <code>if</code> condition on the flags.</li>
<li>Tidyverse provides <code>anti_join()</code>, which returns only the rows of the left input that do NOT have a match in the right input.</li>
<li>Base R achieves the same by subscripting with <code>!(x %in% y)</code> on the join key.</li>
<li>This lesson finds subjects that appear in one dataset but not the other, in both directions.</li>
<li>After running, we should have the names present in the sex dataset but missing from the ahw dataset, and vice versa.</li>
...
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br><br></span><b><span style="color:#000080;background-color:#ffffff;">proc</span></b> <b><span style="color:#000080;background-color:#ffffff;">sort</span></b> <span style="color:#0000ff;background-color:#ffffff;">data</span><span style="color:#000000;background-color:#ffffff;">=sex;<br></span>
...
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br></span><b><span style="color:#000080;background-color:#ffffff;">proc</span></b> <b><span style="color:#000080;background-color:#ffffff;">sort</span></b> <span style="color:#0000ff;background-color:#ffffff;">data</span><span style="color:#000000;background-color:#ffffff;">=ahw;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">by</span><span style="color:#000000;background-color:#ffffff;"> name;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> unmatched;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">merge</span><span style="color:#000000;background-color:#ffffff;"> sex(</span><span style="color:#0000ff;background-color:#ffffff;">in</span><span style="color:#000000;background-color:#ffffff;">=a) ahw(</span><span style="color:#0000ff;background-color:#ffffff;">in</span><span style="color:#000000;background-color:#ffffff;">=b </span><span style="color:#0000ff;background-color:#ffffff;">keep</span><span style="color:#000000;background-color:#ffffff;">=name);<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">by</span><span style="color:#000000;background-color:#ffffff;"> name;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">if</span><span style="color:#000000;background-color:#ffffff;"> a </span><span style="color:#0000ff;background-color:#ffffff;">and</span> <span style="color:#0000ff;background-color:#ffffff;">not</span><span style="color:#000000;background-color:#ffffff;"> b;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br><br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> unmatched;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">merge</span><span style="color:#000000;background-color:#ffffff;"> sex(</span><span style="color:#0000ff;background-color:#ffffff;">in</span><span style="color:#000000;background-color:#ffffff;">=a </span><span style="color:#0000ff;background-color:#ffffff;">keep</span><span style="color:#000000;background-color:#ffffff;">=name) ahw(</span><span style="color:#0000ff;background-color:#ffffff;">in</span><span style="color:#000000;background-color:#ffffff;">=b);<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">by</span><span style="color:#000000;background-color:#ffffff;"> name;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">if</span><span style="color:#000000;background-color:#ffffff;"> b </span><span style="color:#0000ff;background-color:#ffffff;">and</span> <span style="color:#0000ff;background-color:#ffffff;">not</span><span style="color:#000000;background-color:#ffffff;"> a;<br></span>
...
<li>To find unmatched records in SAS, we combine a MERGE with the <code>in=</code> dataset option to track which inputs contributed each row.</li>
<li><code>merge sex(in=a) ahw(in=b); by name;</code> creates boolean flags <code>a</code> and <code>b</code> that are 1 when the current BY group came from that dataset.</li>
<li>Adding <code>if a and not b;</code> keeps only rows present in <code>sex</code> but absent from <code>ahw</code>. Reversing the flags finds the opposite mismatch.</li>
<li>As with any BY merge, both inputs must be sorted on the key first.</li>
<li>The result is a dataset containing only the unmatched rows from the requested side.</li>
...
unmatched&lt;-anti_join(ahw,sex,by=c(&quot;name&quot;))</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>In tidyverse, we use <code>anti_join()</code> for exactly this task.</li>
<li><code>anti_join(sex, ahw, by = "name")</code> returns every row of <code>sex</code> whose name does NOT appear in <code>ahw</code>.</li>
<li>Swapping the arguments &mdash; <code>anti_join(ahw, sex, by = "name")</code> &mdash; returns every row of <code>ahw</code> not in <code>sex</code>.</li>
<li>No columns from the right side are added &mdash; the output shape matches the left side, just with fewer rows.</li>
<li>This is far more direct than an inner join + post-filter, and makes the intent obvious to a reviewer.</li>
...
unmatched &lt;- sex[!(sex$name %in% ahw$name), ]

unmatched &lt;- ahw[!(ahw$name %in% sex$name), ]</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>In base R, we combine the <code>%in%</code> operator with the logical-not <code>!</code> to filter on the key.</li>
<li><code>sex[!(sex$name %in% ahw$name), ]</code> keeps rows of <code>sex</code> whose name is NOT in <code>ahw$name</code>.</li>
<li>Reversing the operands finds the mismatches the other way round.</li>
<li>No join is actually performed &mdash; we are just looking up each left-side name in a right-side vector and keeping the misses.</li>
<li>The result is a data frame with only the unmatched rows.</li>
</ul></div>    </div>  </div></div></div></div></div><script>
    const variants = [{"label":"SAS (Base SAS)","code":"\ndata\u00a0SEX;\ninfile\u00a0datalines\u00a0dlm='|'\u00a0dsd\u00a0missover;\ninput\u00a0Name\u00a0:\u00a0$8.\u00a0Sex\u00a0:\u00a0$1.;\nlabel\u00a0;\nformat\u00a0;\ndatalines4;\nAlfred|MHenry|MMary|F;;;;\nrun;\ndata\u00a0AHW;\ninfile\u00a0datalines\u00a0dlm='|'\u00a0dsd\u00a0missover;\ninput\u00a0Name\u00a0:\u00a0$8.\u00a0Age\u00a0:\u00a0best32.\u00a0Height\u00a0:\u00a0best32.\u00a0Weight\u00a0:\u00a0best32.;\nlabel\u00a0;\nformat\u00a0;\ndatalines4;\nAlfred|14|69|112.5Henry|14|63.5|102.5James|12|57.3|83;;;;\nrun;\nproc\u00a0sort\u00a0data=sex;\n\u00a0\u00a0\u00a0\u00a0by\u00a0name;\nrun;\nproc\u00a0sort\u00a0data=ahw;\n\u00a0\u00a0\u00a0\u00a0by\u00a0name;\nrun;\ndata\u00a0unmatched;\n\u00a0\u00a0\u00a0\u00a0merge\u00a0sex(in=a)\u00a0ahw(in=b\u00a0keep=name);\n\u00a0\u00a0\u00a0\u00a0by\u00a0name;\n\u00a0\u00a0\u00a0\u00a0if\u00a0a\u00a0and\u00a0not\u00a0b;\nrun;\ndata\u00a0unmatched;\n\u00a0\u00a0\u00a0\u00a0merge\u00a0sex(in=a\u00a0keep=name)\u00a0ahw(in=b);\n\u00a0\u00a0\u00a0\u00a0by\u00a0name;\n\u00a0\u00a0\u00a0\u00a0if\u00a0b\u00a0and\u00a0not\u00a0a;\nrun;","language":"sas","html":"<div style=\"font-family: Courier New; font-size: 13pt\">\n<b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0SEX;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">infile<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">datalines<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dlm<\/span><span style=\"color:#000000;background-color:#ffffff;\">=<\/span><span style=\"color:#800080;background-color:#ffffff;\">'|'<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dsd<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">missover<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">input<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Name\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">$8.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Sex\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">$1.<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">label<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">format<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">datalines4<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#89632b;background-color:#ffffc0;\">Alfred|M<br>Henry|M<br>Mary|F<br><\/span><span style=\"color:#000000;background-color:#ffffff;\">;;;;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0AHW;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">infile<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">datalines<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dlm<\/span><span style=\"color:#000000;background-color:#ffffff;\">=<\/span><span style=\"color:#800080;background-color:#ffffff;\">'|'<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dsd<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">missover<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">input<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Name\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">$8.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Age\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Height\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Weight\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">label<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">format<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">datalines4<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#89632b;background-color:#ffffc0;\">Alfred|14|69|112.5<br>Henry|14|63.5|102.5<br>James|12|57.3|83<br><\/span><span style=\"color:#000000;background-color:#ffffff;\">;;;;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">proc<\/span><\/b>\u00a0<b><span style=\"color:#000080;background-color:#ffffff;\">sort<\/span><\/b>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">data<\/span><span style=\"color:#000000;background-color:#ffffff;\">=sex;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">by<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0name;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">proc<\/span><\/b>\u00a0<b><span style=\"color:#000080;background-color:#ffffff;\">sort<\/span><\/b>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">data<\/span><span style=\"color:#000000;background-color:#ffffff;\">=ahw;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">by<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0name;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0unmatched;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">merge<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0sex(<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">in<\/span><span style=\"color:#000000;background-color:#ffffff;\">=a)\u00a0ahw(<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">in<\/span><span style=\"color:#000000;background-color:#ffffff;\">=b\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">keep<\/span><span style=\"color:#000000;background-color:#ffffff;\">=name);<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">by<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0name;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">if<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0a\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">and<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">not<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0b;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0unmatched;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">merge<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0sex(<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">in<\/span><span style=\"color:#000000;background-color:#ffffff;\">=a\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">keep<\/span><span style=\"color:#000000;background-color:#ffffff;\">=name)\u00a0ahw(<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">in<\/span><span style=\"color:#000000;background-color:#ffffff;\">=b);<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">by<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0name;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">if<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0b\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">and<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">not<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0a;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">;<\/span><\/div>"},{"label":"R (tidyverse)","code":"library(tidyverse)\n\nsex<-tribble(\n~name,~sex,\n\"Alfred\",\"M\",\n\"Henry\",\"M\",\n\"Mary\",\"F\",\n)\n\nahw<-tribble(\n~name,~age,~height,~weight,\n\"Alfred\",14,69,112.5,\n\"Henry\",14,63.5,102.5,\n\"James\",12,57.3,83,\n)\n\nunmatched<-anti_join(sex,ahw,by=c(\"name\"))\n\n\nunmatched<-anti_join(ahw,sex,by=c(\"name\"))","language":"r","html":"<pre><code class=\"language-r\">library(tidyverse)\n\nsex&lt;-tribble(\n~name,~sex,\n&quot;Alfred&quot;,&quot;M&quot;,\n&quot;Henry&quot;,&quot;M&quot;,\n&quot;Mary&quot;,&quot;F&quot;,\n)\n\nahw&lt;-tribble(\n~name,~age,~height,~weight,\n&quot;Alfred&quot;,14,69,112.5,\n&quot;Henry&quot;,14,63.5,102.5,\n&quot;James&quot;,12,57.3,83,\n)\n\nunmatched&lt;-anti_join(sex,ahw,by=c(&quot;name&quot;))\n\n\nunmatched&lt;-anti_join(ahw,sex,by=c(&quot;name&quot;))<\/code><\/pre>"},{"label":"R (base)","code":"sex <- data.frame(\n  name = c(\"Alfred\", \"Henry\", \"Mary\"),\n  sex = c(\"M\", \"M\", \"F\")\n  , stringsAsFactors = FALSE\n)\n\nahw <- data.frame(\n  name = c(\"Alfred\", \"Henry\", \"James\"),\n  age = c(14, 14, 12),\n  height = c(69, 63.5, 57.3),\n  weight = c(112.5, 102.5, 83)\n  , stringsAsFactors = FALSE\n)\n\nunmatched <- sex[!(sex$name %in% ahw$name), ]\n\nunmatched <- ahw[!(ahw$name %in% sex$name), ]","language":"r","html":"<pre><code class=\"language-r\">sex &lt;- data.frame(\n  name = c(&quot;Alfred&quot;, &quot;Henry&quot;, &quot;Mary&quot;),\n  sex = c(&quot;M&quot;, &quot;M&quot;, &quot;F&quot;)\n  , stringsAsFactors = FALSE\n)\n\nahw &lt;- data.frame(\n  name = c(&quot;Alfred&quot;, &quot;Henry&quot;, &quot;James&quot;),\n  age = c(14, 14, 12),\n  height = c(69, 63.5, 57.3),\n  weight = c(112.5, 102.5, 83)\n  , stringsAsFactors = FALSE\n)\n\nunmatched &lt;- sex[!(sex$name %in% ahw$name), ]\n\nunmatched &lt;- ahw[!(ahw$name %in% sex$name), ]<\/code><\/pre>"}] || [];
