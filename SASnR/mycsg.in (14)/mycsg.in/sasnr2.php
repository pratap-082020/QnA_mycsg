...
<title>mycsg SASnR2 1860_Merging-datasets---cartesian-product</title>
...
</script><div class='csg-adwrap' id='sasnr-lesson-wrap'><div class='csg-center-col'><center><h2>Merging datasets - cartesian product</h2></center><hr><div class="card mb-3 code-card lang-default">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-default" data-toggle="collapse" data-target="#lessonDesc" style="cursor:pointer;" role="button" aria-expanded="true" aria-controls="lessonDesc">    <h6 class="mb-0">Lesson Description</h6>    <span class="toggle-indicator" data-target="lessonDesc">-</span>  </div>  <div id="lessonDesc" class="collapse show">    <div class="card-body variant-description"><ul>
<li>A Cartesian product (cross join) pairs every row of one dataset with every row of another, producing every possible combination.</li>
<li>In clinical programming this is handy for building summary shells: row categories crossed with treatment arms, for example.</li>
<li>SAS does this with a DATA step using two <code>SET</code> statements without a BY, or via PROC SQL.</li>
<li>Tidyverse provides <code>cross_join()</code>. Base R uses <code>merge()</code> with <code>by = NULL</code>.</li>
<li>This lesson crosses three summary row templates with four treatment arms to produce 12 combinations.</li>
<li>After running, the output dataset has rows * columns = 3 * 4 = 12 rows.</li>
...
<b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> DUMMY01;<br></span>
...
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#0000ff;background-color:#ffffff;">input</span><span style="color:#000000;background-color:#ffffff;"> grouplabel : </span><span style="color:#08726d;background-color:#ffffff;">$100.</span><span style="color:#000000;background-color:#ffffff;"> statistic : </span><span style="color:#08726d;background-color:#ffffff;">$100.</span><span style="color:#000000;background-color:#ffffff;"> group : </span><span style="color:#08726d;background-color:#ffffff;">best32.</span><span style="color:#000000;background-color:#ffffff;"> intord : </span><span style="color:#08726d;background-color:#ffffff;">best32.</span>;
...
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#89632b;background-color:#ffffc0;">Sex, n(%)|Male|2|1<br>Sex, n(%)|Female|2|2<br>Sex, n(%)|Missing|2|99<br></span><span style="color:#000000;background-color:#ffffff;">;;;;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> DUMMY_TREATMENTS;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">infile</span> <span style="color:#0000ff;background-color:#ffffff;">datalines</span> <span style="color:#0000ff;background-color:#ffffff;">dlm</span><span style="color:#000000;background-color:#ffffff;">=</span><span style="color:#800080;background-color:#ffffff;">'|'</span> <span style="color:#0000ff;background-color:#ffffff;">dsd</span> <span style="color:#0000ff;background-color:#ffffff;">missover</span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#0000ff;background-color:#ffffff;">input</span><span style="color:#000000;background-color:#ffffff;"> treatment : </span><span style="color:#08726d;background-color:#ffffff;">best32.</span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#0000ff;background-color:#ffffff;">label</span><span style="color:#000000;background-color:#ffffff;"> ;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">format</span><span style="color:#000000;background-color:#ffffff;"> ;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">datalines4</span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#89632b;background-color:#ffffc0;">1<br>2<br>3<br>4<br></span><span style="color:#000000;background-color:#ffffff;">;;;;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br><br></span><b><span style="color:#000080;background-color:#ffffff;">proc</span></b> <b><span style="color:#000080;background-color:#ffffff;">sql</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br>    </span><span style="color:#0000ff;background-color:#ffffff;">create</span> <span style="color:#0000ff;background-color:#ffffff;">table</span><span style="color:#000000;background-color:#ffffff;"> dummy02 </span><span style="color:#0000ff;background-color:#ffffff;">as</span><span style="color:#000000;background-color:#ffffff;"><br>        </span><span style="color:#0000ff;background-color:#ffffff;">select</span><span style="color:#000000;background-color:#ffffff;"> *<br>        </span><span style="color:#0000ff;background-color:#ffffff;">from</span><span style="color:#000000;background-color:#ffffff;"> dummy01,dummy_treatments;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">quit</span></b><span style="color:#000000;background-color:#ffffff;">;</span></div>      </div><div class="variant-description mt-2"><ul>
<li>To build a Cartesian product in SAS, we can write a DATA step that reads one dataset in full and, for each observation, loops through every observation of the other.</li>
<li>A compact alternative is <code>PROC SQL; create table x as select * from a, b; quit;</code> &mdash; SQL&rsquo;s comma-join syntax is a Cartesian product by default.</li>
<li>Another option is two <code>SET</code> statements with <code>point=</code> and a <code>do</code> loop &mdash; more code but avoids SQL if we prefer DATA-step syntax.</li>
<li>All three approaches produce the same output: every row of one input paired with every row of the other.</li>
<li>Expected row count is n1 * n2 &mdash; we check this before trusting the result.</li>
...
dummy02&lt;-cross_join(dummy01,dummy_treatments)</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>In tidyverse, <code>cross_join()</code> from dplyr builds the full cross-product in a single call.</li>
<li><code>cross_join(dummy01, dummy_treatments)</code> pairs every row of the first with every row of the second &mdash; n1 * n2 rows in the result.</li>
<li>No <code>by =</code> argument is needed &mdash; cross_join deliberately ignores keys.</li>
<li>For cross-joining named vectors rather than tibbles, the same result comes from <code>tidyr::crossing()</code>.</li>
<li>The expected row count is always n1 * n2, which we check with <code>nrow()</code> before moving on.</li>
</ul></div>    </div>  </div></div><div class="card mb-2 code-card lang-r-base">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-r-base" data-toggle="collapse" data-target="#collapse2" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse2">    <h6 class="mb-0"><span class="badge badge-success mr-2">R</span> (base)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse2">Copy</button>      <span class="toggle-indicator" data-target="collapse2">+</span>    </div>  </div>  <div id="collapse2" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse2"><pre><code class="language-r">dummy01 &lt;- data.frame(
...
dummy02 &lt;- merge(dummy01, dummy_treatments, by = NULL)</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>In base R, we build a Cartesian product with <code>merge(x, y, by = NULL)</code>.</li>
<li>Setting <code>by = NULL</code> tells <code>merge()</code> there is no join key &mdash; which forces the function to pair every row of x with every row of y.</li>
<li>For named vectors rather than data frames, <code>expand.grid()</code> works the same way: <code>expand.grid(x = 1:3, y = c("a","b"))</code> gives 6 combinations.</li>
<li>These are the base R analogues of tidyverse <code>cross_join()</code> and <code>crossing()</code> respectively.</li>
<li>After running, we verify the row count equals n1 * n2 exactly.</li>
</ul></div>    </div>  </div></div></div></div></div><script>
    const variants = [{"label":"SAS (Base SAS)","code":"\ndata\u00a0DUMMY01;\ninfile\u00a0datalines\u00a0dlm='|'\u00a0dsd\u00a0missover;\ninput\u00a0grouplabel\u00a0:\u00a0$100.\u00a0statistic\u00a0:\u00a0$100.\u00a0group\u00a0:\u00a0best32.\u00a0intord\u00a0:\u00a0best32.;\nlabel\u00a0;\nformat\u00a0;\ndatalines4;\nSex,\u00a0n(%)|Male|2|1Sex,\u00a0n(%)|Female|2|2Sex,\u00a0n(%)|Missing|2|99;;;;\nrun;\ndata\u00a0DUMMY_TREATMENTS;\ninfile\u00a0datalines\u00a0dlm='|'\u00a0dsd\u00a0missover;\ninput\u00a0treatment\u00a0:\u00a0best32.;\nlabel\u00a0;\nformat\u00a0;\ndatalines4;\n1234;;;;\nrun;\nproc\u00a0sql;\n\u00a0\u00a0\u00a0\u00a0create\u00a0table\u00a0dummy02\u00a0as\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0select\u00a0*\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0from\u00a0dummy01,dummy_treatments;\nquit;","language":"sas","html":"<div style=\"font-family: Courier New; font-size: 13pt\">\n<b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0DUMMY01;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">infile<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">datalines<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dlm<\/span><span style=\"color:#000000;background-color:#ffffff;\">=<\/span><span style=\"color:#800080;background-color:#ffffff;\">'|'<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dsd<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">missover<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">input<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0grouplabel\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">$100.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0statistic\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">$100.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0group\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0intord\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">label<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">format<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">datalines4<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#89632b;background-color:#ffffc0;\">Sex,\u00a0n(%)|Male|2|1<br>Sex,\u00a0n(%)|Female|2|2<br>Sex,\u00a0n(%)|Missing|2|99<br><\/span><span style=\"color:#000000;background-color:#ffffff;\">;;;;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0DUMMY_TREATMENTS;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">infile<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">datalines<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dlm<\/span><span style=\"color:#000000;background-color:#ffffff;\">=<\/span><span style=\"color:#800080;background-color:#ffffff;\">'|'<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dsd<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">missover<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">input<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0treatment\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">label<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">format<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">datalines4<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#89632b;background-color:#ffffc0;\">1<br>2<br>3<br>4<br><\/span><span style=\"color:#000000;background-color:#ffffff;\">;;;;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">proc<\/span><\/b>\u00a0<b><span style=\"color:#000080;background-color:#ffffff;\">sql<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br>\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">create<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">table<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0dummy02\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">as<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br>\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">select<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0*<br>\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">from<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0dummy01,dummy_treatments;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">quit<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">;<\/span><\/div>"},{"label":"R (tidyverse)","code":"library(tidyverse)\n\ndummy01<-tribble(\n~grouplabel,~statistic,~group,~intord,\n\"Sex, n(%)\",\"Male\",2,1,\n\"Sex, n(%)\",\"Female\",2,2,\n\"Sex, n(%)\",\"Missing\",2,99,\n)\n\ndummy_treatments<-tribble(\n~treatment,\n1,\n2,\n3,\n4,\n)\n\ndummy02<-cross_join(dummy01,dummy_treatments)","language":"r","html":"<pre><code class=\"language-r\">library(tidyverse)\n\ndummy01&lt;-tribble(\n~grouplabel,~statistic,~group,~intord,\n&quot;Sex, n(%)&quot;,&quot;Male&quot;,2,1,\n&quot;Sex, n(%)&quot;,&quot;Female&quot;,2,2,\n&quot;Sex, n(%)&quot;,&quot;Missing&quot;,2,99,\n)\n\ndummy_treatments&lt;-tribble(\n~treatment,\n1,\n2,\n3,\n4,\n)\n\ndummy02&lt;-cross_join(dummy01,dummy_treatments)<\/code><\/pre>"},{"label":"R (base)","code":"dummy01 <- data.frame(\n  grouplabel = c(\"Sex, n(%)\", \"Sex, n(%)\", \"Sex, n(%)\"),\n  statistic = c(\"Male\", \"Female\", \"Missing\"),\n  group = c(2, 2, 2),\n  intord = c(1, 2, 99)\n  , stringsAsFactors = FALSE\n)\n\ndummy_treatments <- data.frame(\n  treatment = c(1, 2, 3, 4)\n  , stringsAsFactors = FALSE\n)\n\ndummy02 <- merge(dummy01, dummy_treatments, by = NULL)","language":"r","html":"<pre><code class=\"language-r\">dummy01 &lt;- data.frame(\n  grouplabel = c(&quot;Sex, n(%)&quot;, &quot;Sex, n(%)&quot;, &quot;Sex, n(%)&quot;),\n  statistic = c(&quot;Male&quot;, &quot;Female&quot;, &quot;Missing&quot;),\n  group = c(2, 2, 2),\n  intord = c(1, 2, 99)\n  , stringsAsFactors = FALSE\n)\n\ndummy_treatments &lt;- data.frame(\n  treatment = c(1, 2, 3, 4)\n  , stringsAsFactors = FALSE\n)\n\ndummy02 &lt;- merge(dummy01, dummy_treatments, by = NULL)<\/code><\/pre>"}] || [];
