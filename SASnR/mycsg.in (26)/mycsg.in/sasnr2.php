...
<title>mycsg SASnR2 2300_Handling-duplicates</title>
...
</script><div class='csg-adwrap' id='sasnr-lesson-wrap'><div class='csg-center-col'><center><h2>Handling duplicates</h2></center><hr><div class="card mb-3 code-card lang-default">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-default" data-toggle="collapse" data-target="#lessonDesc" style="cursor:pointer;" role="button" aria-expanded="true" aria-controls="lessonDesc">    <h6 class="mb-0">Lesson Description</h6>    <span class="toggle-indicator" data-target="lessonDesc">-</span>  </div>  <div id="lessonDesc" class="collapse show">    <div class="card-body variant-description"><ul>
<li>Duplicate rows come up in almost every real dataset &mdash; a subject entered twice, a lab value repeated across two sources, a merge that accidentally widened the data.</li>
<li>Two common asks: keep one row per key combination (<code>nodupkey</code> in SAS), or remove rows that are exact copies across every column (<code>nodup</code> / <code>noduprec</code> in SAS).</li>
<li>In SAS, <code>proc sort nodupkey</code> keeps one row per BY-group; <code>proc sort noduprec</code> drops full-row duplicates when paired with <code>by _all_</code>.</li>
<li>Tidyverse: <code>distinct()</code> for full-row deduplication; <code>group_by() %&gt;% slice(1)</code> for one row per key combination.</li>
<li>Base R: <code>!duplicated(df)</code> for full rows; <code>!duplicated(df[c("k1","k2")])</code> for a key-based version after sorting.</li>
<li>This lesson works two small AE datasets &mdash; one where duplication is key-based and one where full rows repeat &mdash; so we can see both patterns side by side.</li>
</ul>    </div>  </div></div><div id="codeAccordion" class="mb-4"><div class="card mb-2 code-card lang-sas">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-sas" data-toggle="collapse" data-target="#collapse0" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse0">    <h6 class="mb-0"><span class="badge badge-primary mr-2">SAS</span> (Base SAS)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse0">Copy</button>      <span class="toggle-indicator" data-target="collapse0">+</span>    </div>  </div>  <div id="collapse0" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse0"><div style="font-family: Courier New; font-size: 13pt;"><strong><span style="color: #000080; background-color: #ffffff;">data</span></strong><span style="color: #000000; background-color: #ffffff;"> AE;<br></span> <span style="color: #0000ff; background-color: #ffffff;">infile</span> <span style="color: #0000ff; background-color: #ffffff;">datalines</span> <span style="color: #0000ff; background-color: #ffffff;">dlm</span><span style="color: #000000; background-color: #ffffff;">=</span><span style="color: #800080; background-color: #ffffff;">'|'</span> <span style="color: #0000ff; background-color: #ffffff;">dsd</span> <span style="color: #0000ff; background-color: #ffffff;">missover</span>; <span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #0000ff; background-color: #ffffff;">input</span><span style="color: #000000; background-color: #ffffff;"> subjid : </span><span style="color: #08726d; background-color: #ffffff;">$10.</span><span style="color: #000000; background-color: #ffffff;"> term : </span><span style="color: #08726d; background-color: #ffffff;">$20.</span><span style="color: #000000; background-color: #ffffff;"> stdtc : </span><span style="color: #08726d; background-color: #ffffff;">$10.</span>; <span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #0000ff; background-color: #ffffff;">label</span><span style="color: #000000; background-color: #ffffff;"> ;<br></span> <span style="color: #0000ff; background-color: #ffffff;">format</span><span style="color: #000000; background-color: #ffffff;"> ;<br></span> <span style="color: #0000ff; background-color: #ffffff;">datalines4</span>; <span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #89632b; background-color: #ffffc0;">1001|Headache|2010-01-05<br>1001|Headache|2010-01-08<br>1001|Nausea|2010-01-08<br>1002|Headache|2010-02-15<br></span><span style="color: #000000; background-color: #ffffff;">;;;;<br></span> <strong><span style="color: #000080; background-color: #ffffff;">run</span></strong>; <span style="color: #000000; background-color: #ffffff;"><br><br></span><strong><span style="color: #000080; background-color: #ffffff;">data</span></strong><span style="color: #000000; background-color: #ffffff;"> AE1;<br></span> <span style="color: #0000ff; background-color: #ffffff;">infile</span> <span style="color: #0000ff; background-color: #ffffff;">datalines</span> <span style="color: #0000ff; background-color: #ffffff;">dlm</span><span style="color: #000000; background-color: #ffffff;">=</span><span style="color: #800080; background-color: #ffffff;">'|'</span> <span style="color: #0000ff; background-color: #ffffff;">dsd</span> <span style="color: #0000ff; background-color: #ffffff;">missover</span>; <span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #0000ff; background-color: #ffffff;">input</span><span style="color: #000000; background-color: #ffffff;"> subjid : </span><span style="color: #08726d; background-color: #ffffff;">$10.</span><span style="color: #000000; background-color: #ffffff;"> term : </span><span style="color: #08726d; background-color: #ffffff;">$20.</span><span style="color: #000000; background-color: #ffffff;"> stdtc : </span><span style="color: #08726d; background-color: #ffffff;">$10.</span>; <span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #0000ff; background-color: #ffffff;">label</span><span style="color: #000000; background-color: #ffffff;"> ;<br></span> <span style="color: #0000ff; background-color: #ffffff;">format</span><span style="color: #000000; background-color: #ffffff;"> ;<br></span> <span style="color: #0000ff; background-color: #ffffff;">datalines4</span>; <span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #89632b; background-color: #ffffc0;">1001|Headache|2010-01-05<br>1001|Headache|2010-01-08<br>1001|Nausea|2010-01-08<br>1002|Headache|2010-02-15<br>1002|Headache|2010-02-15<br></span><span style="color: #000000; background-color: #ffffff;">;;;;<br></span> <strong><span style="color: #000080; background-color: #ffffff;">run</span></strong>; <span style="color: #000000; background-color: #ffffff;"><br><br></span><span style="color: #1b7a1b; background-color: #ffffff;">*------------------------------------------------------------------------------;</span><span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #1b7a1b; background-color: #ffffff;">*nodupkey;</span><span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #1b7a1b; background-color: #ffffff;">*------------------------------------------------------------------------------;</span><span style="color: #000000; background-color: #ffffff;"><br><br></span><strong><span style="color: #000080; background-color: #ffffff;">proc</span></strong> <strong><span style="color: #000080; background-color: #ffffff;">sort</span></strong> <span style="color: #0000ff; background-color: #ffffff;">data</span><span style="color: #000000; background-color: #ffffff;">=ae;<br></span> <span style="color: #000000; background-color: #ffffff;">    </span><span style="color: #0000ff; background-color: #ffffff;">by</span><span style="color: #000000; background-color: #ffffff;"> subjid term stdtc;<br></span> <strong><span style="color: #000080; background-color: #ffffff;">run</span></strong>; <span style="color: #000000; background-color: #ffffff;"><br><br></span><strong><span style="color: #000080; background-color: #ffffff;">proc</span></strong> <strong><span style="color: #000080; background-color: #ffffff;">sort</span></strong> <span style="color: #0000ff; background-color: #ffffff;">data</span><span style="color: #000000; background-color: #ffffff;">=ae </span><span style="color: #0000ff; background-color: #ffffff;">out</span><span style="color: #000000; background-color: #ffffff;">=</span><span style="color: #0000ff; background-color: #ffffff;">nodupkey</span> <span style="color: #0000ff; background-color: #ffffff;">nodupkey</span>; <span style="color: #000000; background-color: #ffffff;"><br>    </span><span style="color: #0000ff; background-color: #ffffff;">by</span><span style="color: #000000; background-color: #ffffff;"> subjid term;<br></span> <strong><span style="color: #000080; background-color: #ffffff;">run</span></strong>; <span style="color: #000000; background-color: #ffffff;"><br><br><br></span><span style="color: #1b7a1b; background-color: #ffffff;">*------------------------------------------------------------------------------;</span><span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #1b7a1b; background-color: #ffffff;">*noduprec;</span><span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #1b7a1b; background-color: #ffffff;">*------------------------------------------------------------------------------;</span><span style="color: #000000; background-color: #ffffff;"><br><br></span><strong><span style="color: #000080; background-color: #ffffff;">proc</span></strong> <strong><span style="color: #000080; background-color: #ffffff;">sort</span></strong> <span style="color: #0000ff; background-color: #ffffff;">data</span><span style="color: #000000; background-color: #ffffff;">=ae1 </span><span style="color: #0000ff; background-color: #ffffff;">out</span><span style="color: #000000; background-color: #ffffff;">=noduprec noduprec;<br></span> <span style="color: #000000; background-color: #ffffff;">    </span><span style="color: #0000ff; background-color: #ffffff;">by</span><span style="color: #000000; background-color: #ffffff;"> _all_;<br></span> <strong><span style="color: #000080; background-color: #ffffff;">run</span></strong><span style="color: #000000; background-color: #ffffff;">;</span></div>      </div><div class="variant-description mt-2"><ul>
<li>SAS folds deduplication into PROC SORT through two options: <code>nodupkey</code> and <code>noduprec</code>.</li>
<li><code>proc sort data=ae out=nodupkey nodupkey; by subjid term;</code> keeps the first row per (<code>subjid</code>, <code>term</code>) combination and drops any repeats within that key.</li>
<li>The option looks only at the variables listed in the <code>by</code> statement &mdash; columns outside the key, such as <code>stdtc</code>, are ignored when deciding whether a row is a duplicate.</li>
<li>Because <code>nodupkey</code> keeps the first occurrence, a preceding sort is important: it decides which record survives when several match on the key.</li>
<li><code>proc sort data=ae1 out=noduprec noduprec; by _all_;</code> drops rows that match an earlier row on every single column.</li>
<li><code>by _all_;</code> is the SAS shorthand for "use every variable in the dataset", which is the right key list for full-row deduplication.</li>
<li>After running, NODUPKEY has one row per subject-term pair; NODUPREC has the AE1 rows with exact-copy repeats removed.</li>
...
noduprec &lt;- ae1 %&gt;%
  distinct()</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>Tidyverse splits the job into two clear calls: <code>distinct()</code> for full-row deduplication and <code>group_by() %&gt;% slice(1)</code> for key-based deduplication.</li>
<li><code>ae %&gt;% arrange(subjid, term, stdtc) %&gt;% group_by(subjid, term) %&gt;% slice(1)</code> is the direct tidyverse equivalent of <code>proc sort nodupkey by subjid term</code>.</li>
<li>The <code>arrange()</code> step controls which row survives within each key combination &mdash; typically we sort so the earliest or most informative row lands first.</li>
<li><code>slice(1)</code> keeps just the first row per group; switch to <code>slice(n())</code> to keep the last row per group, equivalent to picking the latest record.</li>
<li><code>ae1 %&gt;% distinct()</code> drops rows that are exact copies across every column &mdash; the tidyverse counterpart of <code>proc sort noduprec</code>.</li>
<li><code>distinct()</code> accepts a variable list too: <code>distinct(subjid, term, .keep_all = TRUE)</code> keeps the first row per key and retains the rest of the columns.</li>
<li>We run and compare the counts in NODUPKEY and NODUPREC against the SAS output &mdash; they should line up row for row.</li>
</ul></div>    </div>  </div></div><div class="card mb-2 code-card lang-r-base">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-r-base" data-toggle="collapse" data-target="#collapse2" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse2">    <h6 class="mb-0"><span class="badge badge-success mr-2">R</span> (base)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse2">Copy</button>      <span class="toggle-indicator" data-target="collapse2">+</span>    </div>  </div>  <div id="collapse2" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse2"><pre><code class="language-r">ae &lt;- data.frame(
...
noduprec &lt;- ae1[!duplicated(ae1), ]</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>Base R uses <code>duplicated()</code> in two shapes depending on how we want to define "duplicate".</li>
<li>For a key-based version: sort first with <code>order(subjid, term, stdtc)</code>, then apply <code>!duplicated(df[c("subjid", "term")])</code> to keep the first row per key.</li>
<li>Passing a data frame slice to <code>duplicated()</code> tells R to compare rows only on those selected columns &mdash; exactly the SAS <code>nodupkey by subjid term</code> behaviour.</li>
<li>For full-row deduplication: <code>ae1[!duplicated(ae1), ]</code> drops rows that are exact copies of an earlier row across every column.</li>
<li>No sort is required for the full-row case &mdash; <code>duplicated()</code> keeps the first occurrence and removes later exact matches regardless of order.</li>
<li>We run and confirm the results match the tidyverse and SAS equivalents; the row counts should be identical across all three approaches.</li>
</ul></div>    </div>  </div></div></div></div></div><script>
    const variants = [{"label":"SAS (Base SAS)","code":"data\u00a0AE; infile\u00a0datalines\u00a0dlm='|'\u00a0dsd\u00a0missover; input\u00a0subjid\u00a0:\u00a0$10.\u00a0term\u00a0:\u00a0$20.\u00a0stdtc\u00a0:\u00a0$10.; label\u00a0; format\u00a0; datalines4; 1001|Headache|2010-01-051001|Headache|2010-01-081001|Nausea|2010-01-081002|Headache|2010-02-15;;;; run; data\u00a0AE1; infile\u00a0datalines\u00a0dlm='|'\u00a0dsd\u00a0missover; input\u00a0subjid\u00a0:\u00a0$10.\u00a0term\u00a0:\u00a0$20.\u00a0stdtc\u00a0:\u00a0$10.; label\u00a0; format\u00a0; datalines4; 1001|Headache|2010-01-051001|Headache|2010-01-081001|Nausea|2010-01-081002|Headache|2010-02-151002|Headache|2010-02-15;;;; run; *------------------------------------------------------------------------------;*nodupkey;*------------------------------------------------------------------------------;proc\u00a0sort\u00a0data=ae; \u00a0\u00a0\u00a0\u00a0by\u00a0subjid\u00a0term\u00a0stdtc; run; proc\u00a0sort\u00a0data=ae\u00a0out=nodupkey\u00a0nodupkey; \u00a0\u00a0\u00a0\u00a0by\u00a0subjid\u00a0term; run; *------------------------------------------------------------------------------;*noduprec;*------------------------------------------------------------------------------;proc\u00a0sort\u00a0data=ae1\u00a0out=noduprec\u00a0noduprec; \u00a0\u00a0\u00a0\u00a0by\u00a0_all_; run;","language":"sas","html":"<div style=\"font-family: Courier New; font-size: 13pt;\"><strong><span style=\"color: #000080; background-color: #ffffff;\">data<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">\u00a0AE;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">infile<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">datalines<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">dlm<\/span><span style=\"color: #000000; background-color: #ffffff;\">=<\/span><span style=\"color: #800080; background-color: #ffffff;\">'|'<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">dsd<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">missover<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #0000ff; background-color: #ffffff;\">input<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0subjid\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">$10.<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0term\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">$20.<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0stdtc\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">$10.<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #0000ff; background-color: #ffffff;\">label<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">format<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">datalines4<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #89632b; background-color: #ffffc0;\">1001|Headache|2010-01-05<br>1001|Headache|2010-01-08<br>1001|Nausea|2010-01-08<br>1002|Headache|2010-02-15<br><\/span><span style=\"color: #000000; background-color: #ffffff;\">;;;;<br><\/span> <strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong>; <span style=\"color: #000000; background-color: #ffffff;\"><br><br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">data<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">\u00a0AE1;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">infile<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">datalines<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">dlm<\/span><span style=\"color: #000000; background-color: #ffffff;\">=<\/span><span style=\"color: #800080; background-color: #ffffff;\">'|'<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">dsd<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">missover<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #0000ff; background-color: #ffffff;\">input<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0subjid\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">$10.<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0term\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">$20.<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0stdtc\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">$10.<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #0000ff; background-color: #ffffff;\">label<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">format<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">datalines4<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #89632b; background-color: #ffffc0;\">1001|Headache|2010-01-05<br>1001|Headache|2010-01-08<br>1001|Nausea|2010-01-08<br>1002|Headache|2010-02-15<br>1002|Headache|2010-02-15<br><\/span><span style=\"color: #000000; background-color: #ffffff;\">;;;;<br><\/span> <strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong>; <span style=\"color: #000000; background-color: #ffffff;\"><br><br><\/span><span style=\"color: #1b7a1b; background-color: #ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #1b7a1b; background-color: #ffffff;\">*nodupkey;<\/span><span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #1b7a1b; background-color: #ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color: #000000; background-color: #ffffff;\"><br><br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">proc<\/span><\/strong>\u00a0<strong><span style=\"color: #000080; background-color: #ffffff;\">sort<\/span><\/strong>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">data<\/span><span style=\"color: #000000; background-color: #ffffff;\">=ae;<br><\/span> <span style=\"color: #000000; background-color: #ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">by<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0subjid\u00a0term\u00a0stdtc;<br><\/span> <strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong>; <span style=\"color: #000000; background-color: #ffffff;\"><br><br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">proc<\/span><\/strong>\u00a0<strong><span style=\"color: #000080; background-color: #ffffff;\">sort<\/span><\/strong>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">data<\/span><span style=\"color: #000000; background-color: #ffffff;\">=ae\u00a0<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">out<\/span><span style=\"color: #000000; background-color: #ffffff;\">=<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">nodupkey<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">nodupkey<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br>\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">by<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0subjid\u00a0term;<br><\/span> <strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong>; <span style=\"color: #000000; background-color: #ffffff;\"><br><br><br><\/span><span style=\"color: #1b7a1b; background-color: #ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #1b7a1b; background-color: #ffffff;\">*noduprec;<\/span><span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #1b7a1b; background-color: #ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color: #000000; background-color: #ffffff;\"><br><br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">proc<\/span><\/strong>\u00a0<strong><span style=\"color: #000080; background-color: #ffffff;\">sort<\/span><\/strong>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">data<\/span><span style=\"color: #000000; background-color: #ffffff;\">=ae1\u00a0<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">out<\/span><span style=\"color: #000000; background-color: #ffffff;\">=noduprec\u00a0noduprec;<br><\/span> <span style=\"color: #000000; background-color: #ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">by<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0_all_;<br><\/span> <strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">;<\/span><\/div>"},{"label":"R (tidyverse)","code":"library(tidyverse)\n\nae <- tribble(\n\u00a0 ~subjid, ~term, \u00a0 \u00a0 \u00a0 ~stdtc,\n\u00a0 \"1001\", \u00a0\"Headache\", \u00a0\"2010-01-05\",\n\u00a0 \"1001\", \u00a0\"Headache\", \u00a0\"2010-01-08\",\n\u00a0 \"1001\", \u00a0\"Nausea\", \u00a0 \u00a0\"2010-01-08\",\n\u00a0 \"1002\", \u00a0\"Headache\", \u00a0\"2010-02-15\"\n)\n\nae1 <- tribble(\n\u00a0 ~subjid, ~term, \u00a0 \u00a0 \u00a0 ~stdtc,\n\u00a0 \"1001\", \u00a0\"Headache\", \u00a0\"2010-01-05\",\n\u00a0 \"1001\", \u00a0\"Headache\", \u00a0\"2010-01-08\",\n\u00a0 \"1001\", \u00a0\"Nausea\", \u00a0 \u00a0\"2010-01-08\",\n\u00a0 \"1002\", \u00a0\"Headache\", \u00a0\"2010-02-15\",\n\u00a0 \"1002\", \u00a0\"Headache\", \u00a0\"2010-02-15\"\n)\n\n#---------------------------------------\n# Duplicate based on key variables (nodupkey)\n#---------------------------------------\n\nnodupkey <- ae %>%\n\u00a0 arrange(subjid, term, stdtc) %>%\n\u00a0 group_by(subjid, term) %>%\n\u00a0 slice(1)\n\n#---------------------------------------\n# Duplicate record (noduprec \/ nodup)\n#---------------------------------------\n\nnoduprec <- ae1 %>%\n\u00a0 distinct()","language":"r","html":"<pre><code class=\"language-r\">library(tidyverse)\n\nae &lt;- tribble(\n\u00a0 ~subjid, ~term, \u00a0 \u00a0 \u00a0 ~stdtc,\n\u00a0 &quot;1001&quot;, \u00a0&quot;Headache&quot;, \u00a0&quot;2010-01-05&quot;,\n\u00a0 &quot;1001&quot;, \u00a0&quot;Headache&quot;, \u00a0&quot;2010-01-08&quot;,\n\u00a0 &quot;1001&quot;, \u00a0&quot;Nausea&quot;, \u00a0 \u00a0&quot;2010-01-08&quot;,\n\u00a0 &quot;1002&quot;, \u00a0&quot;Headache&quot;, \u00a0&quot;2010-02-15&quot;\n)\n\nae1 &lt;- tribble(\n\u00a0 ~subjid, ~term, \u00a0 \u00a0 \u00a0 ~stdtc,\n\u00a0 &quot;1001&quot;, \u00a0&quot;Headache&quot;, \u00a0&quot;2010-01-05&quot;,\n\u00a0 &quot;1001&quot;, \u00a0&quot;Headache&quot;, \u00a0&quot;2010-01-08&quot;,\n\u00a0 &quot;1001&quot;, \u00a0&quot;Nausea&quot;, \u00a0 \u00a0&quot;2010-01-08&quot;,\n\u00a0 &quot;1002&quot;, \u00a0&quot;Headache&quot;, \u00a0&quot;2010-02-15&quot;,\n\u00a0 &quot;1002&quot;, \u00a0&quot;Headache&quot;, \u00a0&quot;2010-02-15&quot;\n)\n\n#---------------------------------------\n# Duplicate based on key variables (nodupkey)\n#---------------------------------------\n\nnodupkey &lt;- ae %&gt;%\n\u00a0 arrange(subjid, term, stdtc) %&gt;%\n\u00a0 group_by(subjid, term) %&gt;%\n\u00a0 slice(1)\n\n#---------------------------------------\n# Duplicate record (noduprec \/ nodup)\n#---------------------------------------\n\nnoduprec &lt;- ae1 %&gt;%\n\u00a0 distinct()<\/code><\/pre>"},{"label":"R (base)","code":"ae <- data.frame(\r\n  subjid = c(1001, 1001, 1001, 1002),\r\n  term = c(\"Headache\", \"Headache\", \"Nausea\", \"Headache\"),\r\n  stdtc = c(\"2010-01-05\", \"2010-01-08\", \"2010-01-08\", \"2010-02-15\")\r\n  , stringsAsFactors = FALSE\r\n)\r\n\r\nae1 <- data.frame(\r\n  subjid = c(1001, 1001, 1001, 1002, 1002),\r\n  term = c(\"Headache\", \"Headache\", \"Nausea\", \"Headache\", \"Headache\"),\r\n  stdtc = c(\"2010-01-05\", \"2010-01-08\", \"2010-01-08\", \"2010-02-15\", \"2010-02-15\")\r\n  , stringsAsFactors = FALSE\r\n)\r\n\r\n# duplicate based on key variables (nodupkey)\r\n\r\nnodupkey <- ae[order(ae$subjid, ae$term, ae$stdtc), ]\r\n\r\nnodupkey <- nodupkey[!duplicated(nodupkey[c(\"subjid\", \"term\")]), ]\r\n\r\n# duplicate record (noduprec\/nodup)\r\n\r\nnoduprec <- ae1[!duplicated(ae1), ]","language":"r","html":"<pre><code class=\"language-r\">ae &lt;- data.frame(\r\n  subjid = c(1001, 1001, 1001, 1002),\r\n  term = c(&quot;Headache&quot;, &quot;Headache&quot;, &quot;Nausea&quot;, &quot;Headache&quot;),\r\n  stdtc = c(&quot;2010-01-05&quot;, &quot;2010-01-08&quot;, &quot;2010-01-08&quot;, &quot;2010-02-15&quot;)\r\n  , stringsAsFactors = FALSE\r\n)\r\n\r\nae1 &lt;- data.frame(\r\n  subjid = c(1001, 1001, 1001, 1002, 1002),\r\n  term = c(&quot;Headache&quot;, &quot;Headache&quot;, &quot;Nausea&quot;, &quot;Headache&quot;, &quot;Headache&quot;),\r\n  stdtc = c(&quot;2010-01-05&quot;, &quot;2010-01-08&quot;, &quot;2010-01-08&quot;, &quot;2010-02-15&quot;, &quot;2010-02-15&quot;)\r\n  , stringsAsFactors = FALSE\r\n)\r\n\r\n# duplicate based on key variables (nodupkey)\r\n\r\nnodupkey &lt;- ae[order(ae$subjid, ae$term, ae$stdtc), ]\r\n\r\nnodupkey &lt;- nodupkey[!duplicated(nodupkey[c(&quot;subjid&quot;, &quot;term&quot;)]), ]\r\n\r\n# duplicate record (noduprec\/nodup)\r\n\r\nnoduprec &lt;- ae1[!duplicated(ae1), ]<\/code><\/pre>"}] || [];
