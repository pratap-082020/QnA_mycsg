...
<title>mycsg SASnR2 3304_extract_date_parts</title>
...
</script><div class='csg-adwrap' id='sasnr-lesson-wrap'><div class='csg-center-col'><center><h2>Extract Day, Month, Year, Weekday from Date</h2></center><hr><div class="card mb-3 code-card lang-default">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-default" data-toggle="collapse" data-target="#lessonDesc" style="cursor:pointer;" role="button" aria-expanded="true" aria-controls="lessonDesc">    <h6 class="mb-0">Lesson Description</h6>    <span class="toggle-indicator" data-target="lessonDesc">-</span>  </div>  <div id="lessonDesc" class="collapse show">    <div class="card-body variant-description"><ul>
<li>Clinical reports frequently need pieces of a date &mdash; the day, the month, the year, or the name of the weekday &mdash; rather than the whole date at once.</li>
<li>Typical uses: group by month, band by year of enrolment, flag weekend visits, build custom date strings.</li>
<li>SAS offers the date-part functions <code>day()</code>, <code>month()</code>, <code>year()</code>, and <code>weekday()</code> &mdash; each takes a SAS date and returns an integer.</li>
<li>Tidyverse uses the lubridate package: <code>day()</code>, <code>month()</code>, <code>year()</code>, and <code>wday()</code>, with <code>wday(..., label = TRUE)</code> giving the weekday name.</li>
<li>Base R uses <code>format()</code> with <code>%d</code>, <code>%m</code>, <code>%Y</code> to pull out components and <code>weekdays()</code> for the weekday name.</li>
<li>This lesson extracts day, month, year, and weekday from a short vector of birth dates so each result is easy to compare.</li>
</ul>    </div>  </div></div><div id="codeAccordion" class="mb-4"><div class="card mb-2 code-card lang-sas">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-sas" data-toggle="collapse" data-target="#collapse0" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse0">    <h6 class="mb-0"><span class="badge badge-primary mr-2">SAS</span> (Base SAS)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse0">Copy</button>      <span class="toggle-indicator" data-target="collapse0">+</span>    </div>  </div>  <div id="collapse0" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse0"><div style="font-family: Courier New; font-size: 14pt">
<b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> dates;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">input</span><span style="color:#000000;background-color:#ffffff;"> dob : </span><span style="color:#008080;background-color:#ffffff;">date9.</span>;
<span style="color:#000000;background-color:#ffffff;"><br>    </span><span style="color:#0000ff;background-color:#ffffff;">format</span><span style="color:#000000;background-color:#ffffff;"> dob </span><span style="color:#008080;background-color:#ffffff;">date9.</span>;
<span style="color:#000000;background-color:#ffffff;"><br>    </span><span style="color:#0000ff;background-color:#ffffff;">datalines</span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#000000;background-color:#ffffc0;">01JAN2000 <br>15FEB1995 <br>20DEC2010 <br></span>;
<span style="color:#000000;background-color:#ffffff;"><br></span><b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br><br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> extract_parts;<br></span>
<span style="color:#000000;background-color:#ffffff;">    </span><span style="color:#0000ff;background-color:#ffffff;">set</span><span style="color:#000000;background-color:#ffffff;"> dates;<br>    day = day(dob);<br>    month = month(dob);<br>    year = year(dob);<br>    weekday = weekday(dob);<br></span>
...
<li>In SAS, each date part has its own function: <code>day(dob)</code>, <code>month(dob)</code>, <code>year(dob)</code>, <code>weekday(dob)</code>.</li>
<li>The input must be a SAS date value (a number of days since 1960-01-01); <code>input dob : date9.;</code> uses the DATE9 informat to parse strings like <code>01JAN2000</code>.</li>
<li>Applying <code>format dob date9.;</code> makes the raw numeric date display as a human-readable date string.</li>
<li><code>day(dob)</code> returns an integer 1-31; <code>month(dob)</code> returns 1-12; <code>year(dob)</code> returns the four-digit year.</li>
<li><code>weekday(dob)</code> returns 1 for Sunday through 7 for Saturday &mdash; note this differs from the ISO convention where Monday is 1.</li>
<li>We run and inspect EXTRACT_PARTS: confirm the derived day, month, year, and weekday match the input dates.</li>
...
<li>In tidyverse, the lubridate package gives us a clean set of extractor functions that match the SAS names closely.</li>
<li><code>ymd(dob)</code> parses ISO-style date strings ("2000-01-01") into proper Date objects &mdash; the first step before any extraction.</li>
<li><code>day(dob)</code>, <code>month(dob)</code>, <code>year(dob)</code> return integers for the corresponding component.</li>
<li><code>wday(dob, label = TRUE)</code> returns a factor with weekday names (Sun, Mon, ..., Sat) &mdash; convenient for plotting or report layout.</li>
<li>We can drop <code>label = TRUE</code> if the numeric weekday is needed instead &mdash; lubridate uses Sunday = 1 by default, matching SAS.</li>
<li>For a different calendar convention (Monday = 1), pass <code>week_start = 1</code> to <code>wday()</code>.</li>
<li>We run and compare the extracted columns against the SAS output &mdash; values should match row for row.</li>
</ul></div>    </div>  </div></div><div class="card mb-2 code-card lang-r-base">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-r-base" data-toggle="collapse" data-target="#collapse2" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse2">    <h6 class="mb-0"><span class="badge badge-success mr-2">R</span> (base)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse2">Copy</button>      <span class="toggle-indicator" data-target="collapse2">+</span>    </div>  </div>  <div id="collapse2" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse2"><pre><code class="language-r">dates &lt;- data.frame(
...
print(dates)</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>In base R, we convert the date string first and then use <code>format()</code> with classic strftime-style tokens to pull each part out.</li>
<li><code>dates$dob &lt;- as.Date(dates$dob)</code> parses "YYYY-MM-DD" strings into Date objects.</li>
<li><code>format(dates$dob, "%d")</code> returns the day as a zero-padded string; wrap with <code>as.integer()</code> to get a numeric column.</li>
<li><code>format(dates$dob, "%m")</code> gives the month and <code>format(dates$dob, "%Y")</code> gives the four-digit year &mdash; both as strings until coerced to integer.</li>
<li><code>weekdays(dates$dob)</code> returns the weekday name in the current locale &mdash; "Sunday", "Monday", and so on.</li>
<li>For a numeric weekday, use <code>as.POSIXlt(dates$dob)$wday</code> &mdash; 0 for Sunday through 6 for Saturday (note the 0-based convention differs from SAS).</li>
<li>We run and compare the extracted columns against the SAS and tidyverse outputs; the weekday convention difference is worth spotting.</li>
</ul></div>    </div>  </div></div></div></div></div><script>
    const variants = [{"label":"SAS (Base SAS)","code":"\ndata\u00a0dates;\n\u00a0\u00a0\u00a0\u00a0input\u00a0dob\u00a0:\u00a0date9.;\n\u00a0\u00a0\u00a0\u00a0format\u00a0dob\u00a0date9.;\n\u00a0\u00a0\u00a0\u00a0datalines;\n01JAN2000\u00a015FEB1995\u00a020DEC2010\u00a0;\nrun;\ndata\u00a0extract_parts;\n\u00a0\u00a0\u00a0\u00a0set\u00a0dates;\u00a0\u00a0\u00a0\u00a0day\u00a0=\u00a0day(dob);\u00a0\u00a0\u00a0\u00a0month\u00a0=\u00a0month(dob);\u00a0\u00a0\u00a0\u00a0year\u00a0=\u00a0year(dob);\u00a0\u00a0\u00a0\u00a0weekday\u00a0=\u00a0weekday(dob);\nrun;","language":"sas","html":"<div style=\"font-family: Courier New; font-size: 14pt\">\n<b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0dates;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">input<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0dob\u00a0:\u00a0<\/span><span style=\"color:#008080;background-color:#ffffff;\">date9.<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br>\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">format<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0dob\u00a0<\/span><span style=\"color:#008080;background-color:#ffffff;\">date9.<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br>\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">datalines<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#000000;background-color:#ffffc0;\">01JAN2000\u00a0<br>15FEB1995\u00a0<br>20DEC2010\u00a0<br><\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0extract_parts;<br><\/span>\n<span style=\"color:#000000;background-color:#ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color:#0000ff;background-color:#ffffff;\">set<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0dates;<br>\u00a0\u00a0\u00a0\u00a0day\u00a0=\u00a0day(dob);<br>\u00a0\u00a0\u00a0\u00a0month\u00a0=\u00a0month(dob);<br>\u00a0\u00a0\u00a0\u00a0year\u00a0=\u00a0year(dob);<br>\u00a0\u00a0\u00a0\u00a0weekday\u00a0=\u00a0weekday(dob);<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">;<\/span><\/div>"},{"label":"R (tidyverse)","code":"library(tidyverse)\r\nlibrary(lubridate)\r\n\r\ndates <- tribble(\r\n  ~dob,\r\n  \"2000-01-01\",\r\n  \"1995-02-15\",\r\n  \"2010-12-20\"\r\n) %>%\r\n  mutate(dob = ymd(dob)) %>%\r\n  mutate(\r\n    day = day(dob),\r\n    month = month(dob),\r\n    year = year(dob),\r\n    weekday = wday(dob, label = TRUE)\r\n  )","language":"r","html":"<pre><code class=\"language-r\">library(tidyverse)\r\nlibrary(lubridate)\r\n\r\ndates &lt;- tribble(\r\n  ~dob,\r\n  &quot;2000-01-01&quot;,\r\n  &quot;1995-02-15&quot;,\r\n  &quot;2010-12-20&quot;\r\n) %&gt;%\r\n  mutate(dob = ymd(dob)) %&gt;%\r\n  mutate(\r\n    day = day(dob),\r\n    month = month(dob),\r\n    year = year(dob),\r\n    weekday = wday(dob, label = TRUE)\r\n  )<\/code><\/pre>"},{"label":"R (base)","code":"dates <- data.frame(\r\n  dob = c(\"2000-01-01\", \"1995-02-15\", \"2010-12-20\")\r\n  , stringsAsFactors = FALSE\r\n)\r\n\r\ndates$dob <- as.Date(dates$dob)\r\n\r\ndates$day <- as.integer(format(dates$dob, \"%d\"))\r\n\r\ndates$month <- as.integer(format(dates$dob, \"%m\"))\r\n\r\ndates$year <- as.integer(format(dates$dob, \"%Y\"))\r\n\r\ndates$weekday <- weekdays(dates$dob)\r\n\r\nprint(dates)","language":"r","html":"<pre><code class=\"language-r\">dates &lt;- data.frame(\r\n  dob = c(&quot;2000-01-01&quot;, &quot;1995-02-15&quot;, &quot;2010-12-20&quot;)\r\n  , stringsAsFactors = FALSE\r\n)\r\n\r\ndates$dob &lt;- as.Date(dates$dob)\r\n\r\ndates$day &lt;- as.integer(format(dates$dob, &quot;%d&quot;))\r\n\r\ndates$month &lt;- as.integer(format(dates$dob, &quot;%m&quot;))\r\n\r\ndates$year &lt;- as.integer(format(dates$dob, &quot;%Y&quot;))\r\n\r\ndates$weekday &lt;- weekdays(dates$dob)\r\n\r\nprint(dates)<\/code><\/pre>"}] || [];
