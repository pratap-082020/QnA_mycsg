...
<title>mycsg SASnR2 1200_Subset-Observations</title>
...
</script><div class='csg-adwrap' id='sasnr-lesson-wrap'><div class='csg-center-col'><center><h2>Subset Observations</h2></center><hr><div class="card mb-3 code-card lang-default">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-default" data-toggle="collapse" data-target="#lessonDesc" style="cursor:pointer;" role="button" aria-expanded="true" aria-controls="lessonDesc">    <h6 class="mb-0">Lesson Description</h6>    <span class="toggle-indicator" data-target="lessonDesc">-</span>  </div>  <div id="lessonDesc" class="collapse show">    <div class="card-body variant-description"><ul>
<li>Almost every analysis starts by filtering a dataset to a relevant subset &mdash; only males, only a certain age band, only a single site.</li>
<li>SAS typically does this inside a <code>DATA</code> step with a <code>WHERE</code> clause. R has two idiomatic flavours: <code>filter()</code> from dplyr, and <code>[</code>-subscript notation in base R.</li>
<li>This lesson shows two common filters on the CLASS dataset: keep only rows where sex is &ldquo;M&rdquo;, and keep only rows where age is 11 or 12 (the pre-teens).</li>
<li>After running, we should have two new datasets: <code>males</code> with just the male subjects, and <code>preteen</code> with just ages 11 and 12.</li>
</ul>    </div>  </div></div><div id="codeAccordion" class="mb-4"><div class="card mb-2 code-card lang-sas">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-sas" data-toggle="collapse" data-target="#collapse0" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse0">    <h6 class="mb-0"><span class="badge badge-primary mr-2">SAS</span> (Base SAS)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse0">Copy</button>      <span class="toggle-indicator" data-target="collapse0">+</span>    </div>  </div>  <div id="collapse0" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse0"><div style="font-family: Courier New; font-size: 12pt;"><span style="color: #000000; background-color: #ffffff;"><br></span><strong><span style="color: #000080; background-color: #ffffff;">data</span></strong><span style="color: #000000; background-color: #ffffff;"> CLASS;<br></span> <span style="color: #0000ff; background-color: #ffffff;">infile</span> <span style="color: #0000ff; background-color: #ffffff;">datalines</span> <span style="color: #0000ff; background-color: #ffffff;">dlm</span><span style="color: #000000; background-color: #ffffff;">=</span><span style="color: #800080; background-color: #ffffff;">'|'</span> <span style="color: #0000ff; background-color: #ffffff;">dsd</span> <span style="color: #0000ff; background-color: #ffffff;">missover</span>; <span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #0000ff; background-color: #ffffff;">input</span><span style="color: #000000; background-color: #ffffff;"> Name : </span><span style="color: #08726d; background-color: #ffffff;">$8.</span><span style="color: #000000; background-color: #ffffff;"> Sex : </span><span style="color: #08726d; background-color: #ffffff;">$1.</span><span style="color: #000000; background-color: #ffffff;"> Age : </span><span style="color: #08726d; background-color: #ffffff;">best32.</span><span style="color: #000000; background-color: #ffffff;"> Height : </span><span style="color: #08726d; background-color: #ffffff;">best32.</span><span style="color: #000000; background-color: #ffffff;"> Weight : </span><span style="color: #08726d; background-color: #ffffff;">best32.</span>; <span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #0000ff; background-color: #ffffff;">label</span><span style="color: #000000; background-color: #ffffff;"> ;<br></span> <span style="color: #0000ff; background-color: #ffffff;">format</span><span style="color: #000000; background-color: #ffffff;"> ;<br></span> <span style="color: #0000ff; background-color: #ffffff;">datalines4</span>; <span style="color: #000000; background-color: #ffffff;"><br></span><span style="color: #89632b; background-color: #ffffc0;">Alfred|M|14|69|112.5<br>Alice|F|13|56.5|84<br>Carol|F|14|62.8|102.5<br>Henry|M|14|63.5|102.5<br>James|M|12|57.3|83<br></span><span style="color: #000000; background-color: #ffffff;">;;;;<br></span> <strong><span style="color: #000080; background-color: #ffffff;">run</span></strong>; <span style="color: #000000; background-color: #ffffff;"><br> <br></span><strong><span style="color: #000080; background-color: #ffffff;">data</span></strong><span style="color: #000000; background-color: #ffffff;"> males;<br></span> <span style="color: #0000ff; background-color: #ffffff;">set</span><span style="color: #000000; background-color: #ffffff;"> class;<br></span> <span style="color: #0000ff; background-color: #ffffff;">where</span><span style="color: #000000; background-color: #ffffff;"> sex=</span><span style="color: #800080; background-color: #ffffff;">"M"</span>; <span style="color: #000000; background-color: #ffffff;"><br></span><strong><span style="color: #000080; background-color: #ffffff;">run</span></strong>; <span style="color: #000000; background-color: #ffffff;"><br> <br></span><strong><span style="color: #000080; background-color: #ffffff;">data</span></strong><span style="color: #000000; background-color: #ffffff;"> preteen;<br></span> <span style="color: #000000; background-color: #ffffff;">    </span><span style="color: #0000ff; background-color: #ffffff;">set</span><span style="color: #000000; background-color: #ffffff;"> class;<br></span> <span style="color: #000000; background-color: #ffffff;">    </span><span style="color: #0000ff; background-color: #ffffff;">where</span><span style="color: #000000; background-color: #ffffff;"> age in (</span><strong><span style="color: #08726d; background-color: #ffffff;">11</span></strong><span style="color: #000000; background-color: #ffffff;">,</span><strong><span style="color: #08726d; background-color: #ffffff;">12</span></strong><span style="color: #000000; background-color: #ffffff;">);<br></span> <strong><span style="color: #000080; background-color: #ffffff;">run</span></strong>; <span style="color: #000000; background-color: #ffffff;"><br> </span></div>      </div><div class="variant-description mt-2"><ul>
<li>To filter observations in SAS, we write a <code>DATA</code> step with a <code>SET</code> and a <code>WHERE</code> clause.</li>
<li><code>where sex="M";</code> keeps only rows where the sex variable equals the literal string M. SAS applies the WHERE at read time, which is efficient &mdash; rows that fail the test never enter the new dataset at all.</li>
<li>For matching against a list of values, we use the <code>in</code> operator: <code>where age in (11, 12);</code> keeps rows whose age is 11 or 12.</li>
<li>The value list in <code>in</code> can contain literals or macro variables. Character values need quotes; numerics do not.</li>
<li>The output datasets &mdash; <code>males</code> and <code>preteen</code> &mdash; have the same variable structure as CLASS but fewer rows.</li>
...
preteen&lt;-filter(class,Age %in% c(11,12))</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>To filter rows in tidyverse, we use the <code>filter()</code> function from dplyr.</li>
<li><code>filter(class, Sex == "M")</code> reads as &ldquo;from class, keep rows where Sex equals M&rdquo;. The comparison operator is <code>==</code> (double equals) &mdash; a single <code>=</code> is assignment in R.</li>
<li>For multi-value matches we use <code>%in%</code>: <code>filter(class, Age %in% c(11, 12))</code>. This is the direct analogue of the SAS <code>in (11, 12)</code>.</li>
<li><code>filter()</code> is aware of column names without quotes &mdash; we write <code>Sex</code>, not <code>"Sex"</code> &mdash; because dplyr evaluates the expression in the tibble&rsquo;s data context.</li>
<li>The result is a new tibble with only the matching rows. The original <code>class</code> tibble is untouched.</li>
</ul></div>    </div>  </div></div><div class="card mb-2 code-card lang-r-base">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-r-base" data-toggle="collapse" data-target="#collapse2" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse2">    <h6 class="mb-0"><span class="badge badge-success mr-2">R</span> (base)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse2">Copy</button>      <span class="toggle-indicator" data-target="collapse2">+</span>    </div>  </div>  <div id="collapse2" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse2"><pre><code class="language-r">class &lt;- data.frame(
...
preteen &lt;- class[class$Age %in% c(11, 12), ]</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>In base R, the equivalent of <code>filter()</code> is the <code>[rows, cols]</code> subscript on a data frame.</li>
<li><code>class[class$Sex == "M", ]</code> reads as &ldquo;from class, keep rows where Sex is M, and all columns&rdquo;. The trailing comma with nothing after it means &ldquo;every column&rdquo;.</li>
<li>For multi-value matching we use the same <code>%in%</code> operator as tidyverse: <code>class[class$Age %in% c(11, 12), ]</code>.</li>
<li>Notice we have to prefix the column name with <code>class$</code> &mdash; base R needs to be told which data frame the column lives in. dplyr skips that step because of its non-standard evaluation.</li>
<li>The result is a regular data frame with only the rows that passed the test.</li>
</ul></div>    </div>  </div></div></div></div></div><script>
    const variants = [{"label":"SAS (Base SAS)","code":"data\u00a0CLASS; infile\u00a0datalines\u00a0dlm='|'\u00a0dsd\u00a0missover; input\u00a0Name\u00a0:\u00a0$8.\u00a0Sex\u00a0:\u00a0$1.\u00a0Age\u00a0:\u00a0best32.\u00a0Height\u00a0:\u00a0best32.\u00a0Weight\u00a0:\u00a0best32.; label\u00a0; format\u00a0; datalines4; Alfred|M|14|69|112.5Alice|F|13|56.5|84Carol|F|14|62.8|102.5Henry|M|14|63.5|102.5James|M|12|57.3|83;;;; run; \u00a0data\u00a0males; set\u00a0class; where\u00a0sex=\"M\"; run; \u00a0data\u00a0preteen; \u00a0\u00a0\u00a0\u00a0set\u00a0class; \u00a0\u00a0\u00a0\u00a0where\u00a0age\u00a0in\u00a0(11,12); run; \u00a0","language":"sas","html":"<div style=\"font-family: Courier New; font-size: 12pt;\"><span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">data<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">\u00a0CLASS;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">infile<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">datalines<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">dlm<\/span><span style=\"color: #000000; background-color: #ffffff;\">=<\/span><span style=\"color: #800080; background-color: #ffffff;\">'|'<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">dsd<\/span>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">missover<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #0000ff; background-color: #ffffff;\">input<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0Name\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">$8.<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0Sex\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">$1.<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0Age\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">best32.<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0Height\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">best32.<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0Weight\u00a0:\u00a0<\/span><span style=\"color: #08726d; background-color: #ffffff;\">best32.<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #0000ff; background-color: #ffffff;\">label<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">format<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">datalines4<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><span style=\"color: #89632b; background-color: #ffffc0;\">Alfred|M|14|69|112.5<br>Alice|F|13|56.5|84<br>Carol|F|14|62.8|102.5<br>Henry|M|14|63.5|102.5<br>James|M|12|57.3|83<br><\/span><span style=\"color: #000000; background-color: #ffffff;\">;;;;<br><\/span> <strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong>; <span style=\"color: #000000; background-color: #ffffff;\"><br>\u00a0<br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">data<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">\u00a0males;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">set<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0class;<br><\/span> <span style=\"color: #0000ff; background-color: #ffffff;\">where<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0sex=<\/span><span style=\"color: #800080; background-color: #ffffff;\">\"M\"<\/span>; <span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong>; <span style=\"color: #000000; background-color: #ffffff;\"><br>\u00a0<br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">data<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">\u00a0preteen;<br><\/span> <span style=\"color: #000000; background-color: #ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">set<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0class;<br><\/span> <span style=\"color: #000000; background-color: #ffffff;\">\u00a0\u00a0\u00a0\u00a0<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">where<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0age\u00a0in\u00a0(<\/span><strong><span style=\"color: #08726d; background-color: #ffffff;\">11<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">,<\/span><strong><span style=\"color: #08726d; background-color: #ffffff;\">12<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">);<br><\/span> <strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong>; <span style=\"color: #000000; background-color: #ffffff;\"><br>\u00a0<\/span><\/div>"},{"label":"R (tidyverse)","code":"library(tidyverse)\n\nclass<-tribble(\n~Name,~Sex,~Age,~Height,~Weight,\n\"Alfred\",\"M\",14,69,112.5,\n\"Alice\",\"F\",13,56.5,84,\n\"Carol\",\"F\",14,62.8,102.5,\n\"Henry\",\"M\",14,63.5,102.5,\n\"James\",\"M\",12,57.3,83,\n)\n\n\nmales <- filter(class, Sex==\"M\")\n\n\npreteen<-filter(class,Age %in% c(11,12))","language":"r","html":"<pre><code class=\"language-r\">library(tidyverse)\n\nclass&lt;-tribble(\n~Name,~Sex,~Age,~Height,~Weight,\n&quot;Alfred&quot;,&quot;M&quot;,14,69,112.5,\n&quot;Alice&quot;,&quot;F&quot;,13,56.5,84,\n&quot;Carol&quot;,&quot;F&quot;,14,62.8,102.5,\n&quot;Henry&quot;,&quot;M&quot;,14,63.5,102.5,\n&quot;James&quot;,&quot;M&quot;,12,57.3,83,\n)\n\n\nmales &lt;- filter(class, Sex==&quot;M&quot;)\n\n\npreteen&lt;-filter(class,Age %in% c(11,12))<\/code><\/pre>"},{"label":"R (base)","code":"class <- data.frame(\n  Name = c(\"Alfred\", \"Alice\", \"Carol\", \"Henry\", \"James\"),\n  Sex = c(\"M\", \"F\", \"F\", \"M\", \"M\"),\n  Age = c(14, 13, 14, 14, 12),\n  Height = c(69, 56.5, 62.8, 63.5, 57.3),\n  Weight = c(112.5, 84, 102.5, 102.5, 83)\n  , stringsAsFactors = FALSE\n)\n\nmales <- class[class$Sex == \"M\", ]\n\npreteen <- class[class$Age %in% c(11, 12), ]","language":"r","html":"<pre><code class=\"language-r\">class &lt;- data.frame(\n  Name = c(&quot;Alfred&quot;, &quot;Alice&quot;, &quot;Carol&quot;, &quot;Henry&quot;, &quot;James&quot;),\n  Sex = c(&quot;M&quot;, &quot;F&quot;, &quot;F&quot;, &quot;M&quot;, &quot;M&quot;),\n  Age = c(14, 13, 14, 14, 12),\n  Height = c(69, 56.5, 62.8, 63.5, 57.3),\n  Weight = c(112.5, 84, 102.5, 102.5, 83)\n  , stringsAsFactors = FALSE\n)\n\nmales &lt;- class[class$Sex == &quot;M&quot;, ]\n\npreteen &lt;- class[class$Age %in% c(11, 12), ]<\/code><\/pre>"}] || [];
