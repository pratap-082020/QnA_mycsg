...
<title>mycsg SASnR2 3601_Apply_attributes_to_variables</title>
...
<div style="font-family: Courier New; font-size: 14pt;"><br><strong><span style="color: #000080; background-color: #ffffff;">data</span></strong><span style="color: #000000; background-color: #ffffff;"> adsl01;<br></span><span style="color: #000000; background-color: #ffffff;">    </span><span style="color: #0000ff; background-color: #ffffff;">length</span><span style="color: #000000; background-color: #ffffff;"> usubjid $</span><strong><span style="color: #008080; background-color: #ffffff;">10</span></strong><span style="color: #000000; background-color: #ffffff;"> sex $</span><strong><span style="color: #008080; background-color: #ffffff;">1</span></strong><span style="color: #000000; background-color: #ffffff;"> age </span><strong><span style="color: #008080; background-color: #ffffff;">8</span></strong><span style="color: #000000; background-color: #ffffff;"> trt01pn </span><strong><span style="color: #008080; background-color: #ffffff;">8</span></strong>;<br><span style="color: #000000; background-color: #ffffff;">    </span><span style="color: #0000ff; background-color: #ffffff;">input</span><span style="color: #000000; background-color: #ffffff;"> usubjid $ sex $ age trt01pn;<br></span><span style="color: #000000; background-color: #ffffff;">    </span><span style="color: #0000ff; background-color: #ffffff;">datalines</span>;<br><span style="color: #000000; background-color: #ffffc0;">101 M 25 1<br>102 F 30 2<br>103 M 27 1<br></span>;<br><strong><span style="color: #000080; background-color: #ffffff;">run</span></strong>;<br><span style="color: #000000; background-color: #ffffff;"><br></span><strong><span style="color: #000080; background-color: #ffffff;">data</span></strong><span style="color: #000000; background-color: #ffffff;"> adsl02;<br></span><span style="color: #000000; background-color: #ffffff;">    </span><span style="color: #0000ff; background-color: #ffffff;">set</span><span style="color: #000000; background-color: #ffffff;"> adsl01;<br></span><span style="color: #000000; background-color: #ffffff;">     </span><span style="color: #0000ff; background-color: #ffffff;">label</span><span style="color: #000000; background-color: #ffffff;"> <br>     usubjid = </span><span style="color: #800080; background-color: #ffffff;">"Unique Subject Identifier"</span><span style="color: #000000; background-color: #ffffff;"><br>     sex     = </span><span style="color: #800080; background-color: #ffffff;">"Sex"</span><span style="color: #000000; background-color: #ffffff;"><br>     age     = </span><span style="color: #800080; background-color: #ffffff;">"Age"</span><span style="color: #000000; background-color: #ffffff;"><br>      trt01pn = </span><span style="color: #800080; background-color: #ffffff;">"Planned Treatment for Period 01 (N)"</span><span style="color: #000000; background-color: #ffffff;"><br>;<br></span><strong><span style="color: #000080; background-color: #ffffff;">run</span></strong>;<br><span style="color: #000000; background-color: #ffffff;"><br></span><strong><span style="color: #000080; background-color: #ffffff;">proc</span></strong> <strong><span style="color: #000080; background-color: #ffffff;">contents</span></strong> <span style="color: #0000ff; background-color: #ffffff;">data</span><span style="color: #000000; background-color: #ffffff;">=adsl02 </span><span style="color: #0000ff; background-color: #ffffff;">out</span><span style="color: #000000; background-color: #ffffff;">=cont01(</span><span style="color: #0000ff; background-color: #ffffff;">keep</span><span style="color: #000000; background-color: #ffffff;">=name label length);<br></span><strong><span style="color: #000080; background-color: #ffffff;">run</span></strong><span style="color: #000000; background-color: #ffffff;">;</span></div>      </div><div class="variant-description mt-2"><ul>
<li>We create a dataset adsl01 with proper lengths using the LENGTH statement.</li>
<li>Then in a new step, we assign variable labels using the LABEL statement.</li>
<li>These labels help provide human-readable names for variables (visible in procedures like PROC PRINT, PROC REPORT, etc.).</li>
...
<li>We use tribble() to define the dataset adsl01 with four variables.</li>
<li>Using attr(..., "label") , we assign descriptive labels to each variable.</li>
<li>Using attr(..., "length") , we assign length attribute to each variable.</li>
<li>R doesn't enforce character length truncation &mdash; the "length" attribute is just metadata.</li>
<li>Length attribute is just to show for documentation, or SAS-like simulation.</li>
</ul></div>    </div>  </div></div><div class="card mb-2 code-card lang-r-base">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-r-base" data-toggle="collapse" data-target="#collapse2" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse2">    <h6 class="mb-0"><span class="badge badge-success mr-2">R</span> (base)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse2">Copy</button>      <span class="toggle-indicator" data-target="collapse2">+</span>    </div>  </div>  <div id="collapse2" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse2"><pre><code class="language-r">adsl01 &lt;- data.frame(
...
<li>attr(x, "label"/"length") stores metadata on variables.</li>
<li>sapply() collects labels and lengths into a summary table.</li>
</ul></div>    </div>  </div></div></div></div></div><script>
    const variants = [{"label":"SAS (Base SAS)","code":"\u00a0\r\ndata\u00a0adsl01;\u00a0 \u00a0 length\u00a0usubjid\u00a0$10\u00a0sex\u00a0$1\u00a0age\u00a08\u00a0trt01pn\u00a08;\u00a0 \u00a0 input\u00a0usubjid\u00a0$\u00a0sex\u00a0$\u00a0age\u00a0trt01pn;\u00a0 \u00a0 datalines;101 M 25 1102\u00a0F\u00a030\u00a02103\u00a0M\u00a027\u00a01;run;data\u00a0adsl02;\u00a0 \u00a0 set\u00a0adsl01;\u00a0 \u00a0 \u00a0label\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0usubjid\u00a0=\u00a0\"Unique\u00a0Subject\u00a0Identifier\"\u00a0\u00a0\u00a0\u00a0\u00a0sex\u00a0\u00a0\u00a0\u00a0\u00a0=\u00a0\"Sex\"\u00a0\u00a0\u00a0\u00a0\u00a0age\u00a0\u00a0\u00a0\u00a0\u00a0=\u00a0\"Age\"\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0trt01pn\u00a0=\u00a0\"Planned\u00a0Treatment\u00a0for\u00a0Period\u00a001\u00a0(N)\";run;proc\u00a0contents\u00a0data=adsl02\u00a0out=cont01(keep=name\u00a0label\u00a0length);run;","language":"sas","html":"<p>\u00a0<\/p>\r\n<div style=\"font-family: Courier New; font-size: 14pt;\"><br><strong><span style=\"color: #000080; background-color: #ffffff;\">data<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">\u00a0adsl01;<br><\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0 \u00a0 <\/span><span style=\"color: #0000ff; background-color: #ffffff;\">length<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0usubjid\u00a0$<\/span><strong><span style=\"color: #008080; background-color: #ffffff;\">10<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">\u00a0sex\u00a0$<\/span><strong><span style=\"color: #008080; background-color: #ffffff;\">1<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">\u00a0age\u00a0<\/span><strong><span style=\"color: #008080; background-color: #ffffff;\">8<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">\u00a0trt01pn\u00a0<\/span><strong><span style=\"color: #008080; background-color: #ffffff;\">8<\/span><\/strong>;<br><span style=\"color: #000000; background-color: #ffffff;\">\u00a0 \u00a0 <\/span><span style=\"color: #0000ff; background-color: #ffffff;\">input<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0usubjid\u00a0$\u00a0sex\u00a0$\u00a0age\u00a0trt01pn;<br><\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0 \u00a0 <\/span><span style=\"color: #0000ff; background-color: #ffffff;\">datalines<\/span>;<br><span style=\"color: #000000; background-color: #ffffc0;\">101 M 25 1<br>102\u00a0F\u00a030\u00a02<br>103\u00a0M\u00a027\u00a01<br><\/span>;<br><strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong>;<br><span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">data<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">\u00a0adsl02;<br><\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0 \u00a0 <\/span><span style=\"color: #0000ff; background-color: #ffffff;\">set<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0adsl01;<br><\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0 \u00a0 \u00a0<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">label<\/span><span style=\"color: #000000; background-color: #ffffff;\">\u00a0<br>\u00a0\u00a0\u00a0\u00a0\u00a0usubjid\u00a0=\u00a0<\/span><span style=\"color: #800080; background-color: #ffffff;\">\"Unique\u00a0Subject\u00a0Identifier\"<\/span><span style=\"color: #000000; background-color: #ffffff;\"><br>\u00a0\u00a0\u00a0\u00a0\u00a0sex\u00a0\u00a0\u00a0\u00a0\u00a0=\u00a0<\/span><span style=\"color: #800080; background-color: #ffffff;\">\"Sex\"<\/span><span style=\"color: #000000; background-color: #ffffff;\"><br>\u00a0\u00a0\u00a0\u00a0\u00a0age\u00a0\u00a0\u00a0\u00a0\u00a0=\u00a0<\/span><span style=\"color: #800080; background-color: #ffffff;\">\"Age\"<\/span><span style=\"color: #000000; background-color: #ffffff;\"><br>\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0trt01pn\u00a0=\u00a0<\/span><span style=\"color: #800080; background-color: #ffffff;\">\"Planned\u00a0Treatment\u00a0for\u00a0Period\u00a001\u00a0(N)\"<\/span><span style=\"color: #000000; background-color: #ffffff;\"><br>;<br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong>;<br><span style=\"color: #000000; background-color: #ffffff;\"><br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">proc<\/span><\/strong>\u00a0<strong><span style=\"color: #000080; background-color: #ffffff;\">contents<\/span><\/strong>\u00a0<span style=\"color: #0000ff; background-color: #ffffff;\">data<\/span><span style=\"color: #000000; background-color: #ffffff;\">=adsl02\u00a0<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">out<\/span><span style=\"color: #000000; background-color: #ffffff;\">=cont01(<\/span><span style=\"color: #0000ff; background-color: #ffffff;\">keep<\/span><span style=\"color: #000000; background-color: #ffffff;\">=name\u00a0label\u00a0length);<br><\/span><strong><span style=\"color: #000080; background-color: #ffffff;\">run<\/span><\/strong><span style=\"color: #000000; background-color: #ffffff;\">;<\/span><\/div>"},{"label":"R (tidyverse)","code":"#==============================================================================\n# Create the dataset\n#==============================================================================\n\nlibrary(tidyverse)\n\nadsl01 <- tribble(\n\u00a0 ~usubjid, ~sex, ~age, ~trt01pn,\n\u00a0 \"101\", \u00a0 \u00a0\"M\", \u00a0 25, \u00a0 \u00a01,\n\u00a0 \"102\", \u00a0 \u00a0\"F\", \u00a0 30, \u00a0 \u00a02,\n\u00a0 \"103\", \u00a0 \u00a0\"M\", \u00a0 27, \u00a0 \u00a01\n)\n\n\u00a0\n\n#==============================================================================\n# Assign labels and lengths using attr()\n#==============================================================================\n\nattr(adsl01$usubjid, \"label\") <- \"Unique Subject Identifier\"\nattr(adsl01$usubjid, \"length\") <- 10\n\nattr(adsl01$sex, \"label\") <- \"Sex\"\nattr(adsl01$sex, \"length\") <- 1\n\nattr(adsl01$age, \"label\") <- \"Age\"\nattr(adsl01$age, \"length\") <- 8\n\nattr(adsl01$trt01pn, \"label\") <- \"Planned Treatment for Period 01 (N)\"\nattr(adsl01$trt01pn, \"length\") <- 8\n\n\u00a0\n\n#==============================================================================\n# View all labels and lengths\n#==============================================================================\n\n# Create a tibble with variable names and their labels\nlabel_table <- tibble(\n\u00a0 variable = names(adsl01),\n\u00a0 label = map_chr(adsl01, ~ attr(.x, \"label\")),\n\u00a0 length = map_int(adsl01, ~ attr(.x, \"length\"))\n)","language":"r","html":"<pre><code class=\"language-r\">#==============================================================================\n# Create the dataset\n#==============================================================================\n\nlibrary(tidyverse)\n\nadsl01 &lt;- tribble(\n\u00a0 ~usubjid, ~sex, ~age, ~trt01pn,\n\u00a0 &quot;101&quot;, \u00a0 \u00a0&quot;M&quot;, \u00a0 25, \u00a0 \u00a01,\n\u00a0 &quot;102&quot;, \u00a0 \u00a0&quot;F&quot;, \u00a0 30, \u00a0 \u00a02,\n\u00a0 &quot;103&quot;, \u00a0 \u00a0&quot;M&quot;, \u00a0 27, \u00a0 \u00a01\n)\n\n\u00a0\n\n#==============================================================================\n# Assign labels and lengths using attr()\n#==============================================================================\n\nattr(adsl01$usubjid, &quot;label&quot;) &lt;- &quot;Unique Subject Identifier&quot;\nattr(adsl01$usubjid, &quot;length&quot;) &lt;- 10\n\nattr(adsl01$sex, &quot;label&quot;) &lt;- &quot;Sex&quot;\nattr(adsl01$sex, &quot;length&quot;) &lt;- 1\n\nattr(adsl01$age, &quot;label&quot;) &lt;- &quot;Age&quot;\nattr(adsl01$age, &quot;length&quot;) &lt;- 8\n\nattr(adsl01$trt01pn, &quot;label&quot;) &lt;- &quot;Planned Treatment for Period 01 (N)&quot;\nattr(adsl01$trt01pn, &quot;length&quot;) &lt;- 8\n\n\u00a0\n\n#==============================================================================\n# View all labels and lengths\n#==============================================================================\n\n# Create a tibble with variable names and their labels\nlabel_table &lt;- tibble(\n\u00a0 variable = names(adsl01),\n\u00a0 label = map_chr(adsl01, ~ attr(.x, &quot;label&quot;)),\n\u00a0 length = map_int(adsl01, ~ attr(.x, &quot;length&quot;))\n)<\/code><\/pre>"},{"label":"R (base)","code":"adsl01 <- data.frame(\n  usubjid = c(101, 102, 103),\n  sex = c(\"M\", \"F\", \"M\"),\n  age = c(25, 30, 27),\n  trt01pn = c(1, 2, 1)\n  , stringsAsFactors = FALSE\n)\n\nattr(adsl01$usubjid, \"label\") <- \"Unique Subject Identifier\"\nattr(adsl01$usubjid, \"length\") <- 10\n\nattr(adsl01$sex, \"label\") <- \"Sex\"\nattr(adsl01$sex, \"length\") <- 1\n\nattr(adsl01$age, \"label\") <- \"Age\"\nattr(adsl01$age, \"length\") <- 8\n\nattr(adsl01$trt01pn, \"label\") <- \"Planned Treatment for Period 01 (N)\"\nattr(adsl01$trt01pn, \"length\") <- 8\n\nlabel_table <- data.frame(\n  variable = names(adsl01),\n  label = sapply(adsl01, function(x) attr(x, \"label\")),\n  length = sapply(adsl01, function(x) attr(x, \"length\")),\n  stringsAsFactors = FALSE\n)","language":"r","html":"<pre><code class=\"language-r\">adsl01 &lt;- data.frame(\n  usubjid = c(101, 102, 103),\n  sex = c(&quot;M&quot;, &quot;F&quot;, &quot;M&quot;),\n  age = c(25, 30, 27),\n  trt01pn = c(1, 2, 1)\n  , stringsAsFactors = FALSE\n)\n\nattr(adsl01$usubjid, &quot;label&quot;) &lt;- &quot;Unique Subject Identifier&quot;\nattr(adsl01$usubjid, &quot;length&quot;) &lt;- 10\n\nattr(adsl01$sex, &quot;label&quot;) &lt;- &quot;Sex&quot;\nattr(adsl01$sex, &quot;length&quot;) &lt;- 1\n\nattr(adsl01$age, &quot;label&quot;) &lt;- &quot;Age&quot;\nattr(adsl01$age, &quot;length&quot;) &lt;- 8\n\nattr(adsl01$trt01pn, &quot;label&quot;) &lt;- &quot;Planned Treatment for Period 01 (N)&quot;\nattr(adsl01$trt01pn, &quot;length&quot;) &lt;- 8\n\nlabel_table &lt;- data.frame(\n  variable = names(adsl01),\n  label = sapply(adsl01, function(x) attr(x, &quot;label&quot;)),\n  length = sapply(adsl01, function(x) attr(x, &quot;length&quot;)),\n  stringsAsFactors = FALSE\n)<\/code><\/pre>"}] || [];
