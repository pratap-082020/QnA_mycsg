...
<title>mycsg SASnR2 4025_export_data_to_excel_workbook</title>
...
</script><div class='csg-adwrap' id='sasnr-lesson-wrap'><div class='csg-center-col'><center><h2>Export data to Excel workbook</h2></center><hr><div class="card mb-3 code-card lang-default">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-default" data-toggle="collapse" data-target="#lessonDesc" style="cursor:pointer;" role="button" aria-expanded="true" aria-controls="lessonDesc">    <h6 class="mb-0">Lesson Description</h6>    <span class="toggle-indicator" data-target="lessonDesc">-</span>  </div>  <div id="lessonDesc" class="collapse show">    <div class="card-body variant-description"><ul>
<li>Use PROC EXPORT in SAS to write an Excel file.</li>
<li>In R, use writexl to create .xlsx files.</li>
<li>Update file paths to your local machine.</li>
</ul>    </div>  </div></div><div id="codeAccordion" class="mb-4"><div class="card mb-2 code-card lang-sas">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-sas" data-toggle="collapse" data-target="#collapse0" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse0">    <h6 class="mb-0"><span class="badge badge-primary mr-2">SAS</span> (Base SAS)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse0">Copy</button>      <span class="toggle-indicator" data-target="collapse0">+</span>    </div>  </div>  <div id="collapse0" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse0"><pre><code class="language-sas-mini">proc export data=males outfile=&quot;path\\males_export.xlsx&quot; replace;
run;</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>PROC EXPORT writes the SAS dataset to an Excel file.</li>
</ul></div>    </div>  </div></div><div class="card mb-2 code-card lang-r-tidyverse">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-r-tidyverse" data-toggle="collapse" data-target="#collapse1" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse1">    <h6 class="mb-0"><span class="badge badge-success mr-2">R</span> (tidyverse)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse1">Copy</button>      <span class="toggle-indicator" data-target="collapse1">+</span>    </div>  </div>  <div id="collapse1" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse1"><pre><code class="language-r">library(writexl)

write_xlsx(males, &quot;path/males_writexlsx.xlsx&quot;)

write_xlsx(list(class = class, Males = males), &quot;path/multisheets_writexlsx.xlsx&quot;)</code></pre>      </div><div class="variant-description mt-2"><ul>
<li><code>write_xlsx()</code> writes a data frame to an .xlsx file.</li>
<li>Use a named list to create multiple sheets.</li>
</ul></div>    </div>  </div></div><div class="card mb-2 code-card lang-r-base">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-r-base" data-toggle="collapse" data-target="#collapse2" style="cursor:pointer;" role="button" aria-expanded="false" aria-controls="collapse2">    <h6 class="mb-0"><span class="badge badge-success mr-2">R</span> (base)</h6>    <div class="d-flex align-items-center">      <button type="button" class="btn btn-light btn-sm copy-code-btn mr-2" data-target-code="code-block-collapse2">Copy</button>      <span class="toggle-indicator" data-target="collapse2">+</span>    </div>  </div>  <div id="collapse2" class="collapse">    <div class="card-body">      <div class="variant-code" id="code-block-collapse2"><pre><code class="language-r">library(writexl)

write_xlsx(males, &quot;path/males_writexlsx.xlsx&quot;)</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>Base R can use <code>writexl</code> to export .xlsx files.</li>
</ul></div>    </div>  </div></div></div></div></div><script>
    const variants = [{"label":"SAS (Base SAS)","code":"proc export data=males outfile=\"path\\\\males_export.xlsx\" replace;\nrun;","language":"sas","html":"<pre><code class=\"language-sas-mini\">proc export data=males outfile=&quot;path\\\\males_export.xlsx&quot; replace;\nrun;<\/code><\/pre>"},{"label":"R (tidyverse)","code":"library(writexl)\n\nwrite_xlsx(males, \"path\/males_writexlsx.xlsx\")\n\nwrite_xlsx(list(class = class, Males = males), \"path\/multisheets_writexlsx.xlsx\")","language":"r","html":"<pre><code class=\"language-r\">library(writexl)\n\nwrite_xlsx(males, &quot;path\/males_writexlsx.xlsx&quot;)\n\nwrite_xlsx(list(class = class, Males = males), &quot;path\/multisheets_writexlsx.xlsx&quot;)<\/code><\/pre>"},{"label":"R (base)","code":"library(writexl)\n\nwrite_xlsx(males, \"path\/males_writexlsx.xlsx\")","language":"r","html":"<pre><code class=\"language-r\">library(writexl)\n\nwrite_xlsx(males, &quot;path\/males_writexlsx.xlsx&quot;)<\/code><\/pre>"}] || [];
