...
<title>mycsg SASnR2 5100_mimicking_macro_variable_creation_and_usage</title>
...
</script><div class='csg-adwrap' id='sasnr-lesson-wrap'><div class='csg-center-col'><center><h2>Create a macro variable and use it in open code</h2></center><hr><div class="card mb-3 code-card lang-default">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-default" data-toggle="collapse" data-target="#lessonDesc" style="cursor:pointer;" role="button" aria-expanded="true" aria-controls="lessonDesc">    <h6 class="mb-0">Lesson Description</h6>    <span class="toggle-indicator" data-target="lessonDesc">-</span>  </div>  <div id="lessonDesc" class="collapse show">    <div class="card-body variant-description"><ul>
<li>Programs often need a reusable scalar &mdash; a treatment label to filter on, a study cut-off date, a current version string &mdash; that may change between runs.</li>
<li>The pattern is: define the value once at the top and reference it wherever it is needed.</li>
<li>SAS has a dedicated macro namespace: <code>%let</code> defines a macro variable and <code>&amp;name.</code> references it.</li>
<li>R has no macro layer &mdash; a plain variable in the environment serves the same purpose, referenced by its bare name.</li>
<li>In dplyr, column names and environment variables are disambiguated automatically, so referencing the filter value is as simple as writing its name.</li>
<li>This lesson filters an ADSL sample down to subjects on the Placebo arm, showing the same parameterised pattern in SAS, tidyverse, and base R.</li>
...
<li>To make a reusable scalar in SAS, we define a macro variable with <code>%let</code> and reference it with the <code>&amp;name.</code> syntax.</li>
<li><code>%let trtp_filter = Placebo;</code> creates a macro variable whose value is the text "Placebo" &mdash; no quotes needed in the assignment.</li>
<li>In the DATA step, <code>if trtp = "&trtp_filter.";</code> resolves to <code>if trtp = "Placebo";</code> before SAS compiles the step.</li>
<li>We put the reference inside double quotes so SAS still sees a quoted string literal after macro resolution. Single quotes would prevent resolution &mdash; the <code>&amp;trtp_filter.</code> would be taken as literal text.</li>
<li>The trailing dot terminates the macro variable name &mdash; helpful when the next character could be mistaken for part of the name.</li>
<li>This is the go-to pattern for parameterising a program by study, treatment, cut-off date, or any other single value that might change between runs.</li>
<li>After running, we check <code>adsl_filtered</code> and confirm it contains only the Placebo rows from <code>adsl</code>.</li>
...
adsl_filtered &lt;- adsl %&gt;% 
  filter(trt01p==trt_filter)</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>R does not have a separate macro namespace &mdash; regular variables do the same job.</li>
<li>We assign <code>trt_filter &lt;- "Placebo"</code> with a normal assignment operator. The value lives in the R environment alongside our data.</li>
<li>Inside <code>filter()</code>, we reference the variable by name with no special syntax: <code>filter(trt01p == trt_filter)</code>.</li>
<li>dplyr quietly distinguishes between column names (bare identifiers that exist in the tibble) and environment objects (named values like <code>trt_filter</code>) &mdash; no <code>&amp;</code> or resolution step needed.</li>
<li>This is cleaner than the SAS macro approach for the simple single-value case: one assignment, one reference, and it plays nicely with autocomplete and tooling.</li>
<li>After running, we confirm <code>adsl_filtered</code> only contains the Placebo rows.</li>
...
adsl_filtered &lt;- adsl[adsl$trt01p == trt_filter, ]</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>In base R, the pattern mirrors the tidyverse case: assign the filter value to a regular variable, then reference it by name.</li>
<li><code>trt_filter &lt;- "Placebo"</code> stores the value in the current R environment.</li>
<li><code>adsl[adsl$trt01p == trt_filter, ]</code> uses logical indexing: the condition inside <code>[ , ]</code> picks rows where <code>trt01p</code> matches the filter value.</li>
<li>The trailing comma keeps every column in the output; drop or replace it with a column list to subset columns at the same time.</li>
<li>No macro quoting or special syntax is needed &mdash; R treats <code>trt_filter</code> as a normal value wherever it appears.</li>
<li>We run and confirm <code>adsl_filtered</code> contains only the Placebo rows, matching the SAS and tidyverse outputs exactly.</li>
</ul></div>    </div>  </div></div></div></div></div><script>
    const variants = [{"label":"SAS (Base SAS)","code":"*=============================================================================;\n* Create sample ADSL data;\n*=============================================================================;\n\ndata adsl;\n    input usubjid $ trtp $ age sex $;\n    datalines;\nSUBJ001 Placebo 67 M\nSUBJ002 DrugA   59 F\nSUBJ003 Placebo 72 F\nSUBJ004 DrugB   65 M\nSUBJ005 Placebo 60 F\n;\nrun;\n\n*=============================================================================;\n* Define macro variable and use in filter;\n*=============================================================================;\n\n%let trtp_filter = Placebo;\n\ndata adsl_filtered;\n    set adsl;\n    if trtp = \"&trtp_filter.\";\nrun;","language":"sas","html":"<pre><code class=\"language-sas-mini\">*=============================================================================;\n* Create sample ADSL data;\n*=============================================================================;\n\ndata adsl;\n    input usubjid $ trtp $ age sex $;\n    datalines;\nSUBJ001 Placebo 67 M\nSUBJ002 DrugA   59 F\nSUBJ003 Placebo 72 F\nSUBJ004 DrugB   65 M\nSUBJ005 Placebo 60 F\n;\nrun;\n\n*=============================================================================;\n* Define macro variable and use in filter;\n*=============================================================================;\n\n%let trtp_filter = Placebo;\n\ndata adsl_filtered;\n    set adsl;\n    if trtp = &quot;&amp;trtp_filter.&quot;;\nrun;<\/code><\/pre>"},{"label":"R (tidyverse)","code":"library(tidyverse)\r\n\r\n#==============================================================================\r\n# Create sample ADSL data\r\n#==============================================================================\r\n\r\n\r\nadsl <- tribble(\r\n  ~usubjid, ~trt01p,     ~age, ~sex,\r\n  \"SUBJ001\", \"Placebo\", 67,   \"M\",\r\n  \"SUBJ002\", \"DrugA\",    59,   \"F\",\r\n  \"SUBJ003\", \"Placebo\", 72,   \"F\",\r\n  \"SUBJ004\", \"DrugB\",    65,   \"M\",\r\n  \"SUBJ005\", \"Placebo\", 60,   \"F\"\r\n)\r\n\r\n#==============================================================================;\r\n#Create an object and use it's value in filter function;\r\n#==============================================================================;\r\n\r\ntrt_filter <- \"Placebo\"\r\n\r\nadsl_filtered <- adsl %>% \r\n  filter(trt01p==trt_filter)","language":"r","html":"<pre><code class=\"language-r\">library(tidyverse)\r\n\r\n#==============================================================================\r\n# Create sample ADSL data\r\n#==============================================================================\r\n\r\n\r\nadsl &lt;- tribble(\r\n  ~usubjid, ~trt01p,     ~age, ~sex,\r\n  &quot;SUBJ001&quot;, &quot;Placebo&quot;, 67,   &quot;M&quot;,\r\n  &quot;SUBJ002&quot;, &quot;DrugA&quot;,    59,   &quot;F&quot;,\r\n  &quot;SUBJ003&quot;, &quot;Placebo&quot;, 72,   &quot;F&quot;,\r\n  &quot;SUBJ004&quot;, &quot;DrugB&quot;,    65,   &quot;M&quot;,\r\n  &quot;SUBJ005&quot;, &quot;Placebo&quot;, 60,   &quot;F&quot;\r\n)\r\n\r\n#==============================================================================;\r\n#Create an object and use it&#039;s value in filter function;\r\n#==============================================================================;\r\n\r\ntrt_filter &lt;- &quot;Placebo&quot;\r\n\r\nadsl_filtered &lt;- adsl %&gt;% \r\n  filter(trt01p==trt_filter)<\/code><\/pre>"},{"label":"R (base)","code":"adsl <- data.frame(\r\n  usubjid = c(\"SUBJ001\", \"SUBJ002\", \"SUBJ003\", \"SUBJ004\", \"SUBJ005\"),\r\n  trt01p = c(\"Placebo\", \"DrugA\", \"Placebo\", \"DrugB\", \"Placebo\"),\r\n  age = c(67, 59, 72, 65, 60),\r\n  sex = c(\"M\", \"F\", \"F\", \"M\", \"F\")\r\n  , stringsAsFactors = FALSE\r\n)\r\n\r\ntrt_filter <- \"Placebo\"\r\n\r\nadsl_filtered <- adsl[adsl$trt01p == trt_filter, ]","language":"r","html":"<pre><code class=\"language-r\">adsl &lt;- data.frame(\r\n  usubjid = c(&quot;SUBJ001&quot;, &quot;SUBJ002&quot;, &quot;SUBJ003&quot;, &quot;SUBJ004&quot;, &quot;SUBJ005&quot;),\r\n  trt01p = c(&quot;Placebo&quot;, &quot;DrugA&quot;, &quot;Placebo&quot;, &quot;DrugB&quot;, &quot;Placebo&quot;),\r\n  age = c(67, 59, 72, 65, 60),\r\n  sex = c(&quot;M&quot;, &quot;F&quot;, &quot;F&quot;, &quot;M&quot;, &quot;F&quot;)\r\n  , stringsAsFactors = FALSE\r\n)\r\n\r\ntrt_filter &lt;- &quot;Placebo&quot;\r\n\r\nadsl_filtered &lt;- adsl[adsl$trt01p == trt_filter, ]<\/code><\/pre>"}] || [];
