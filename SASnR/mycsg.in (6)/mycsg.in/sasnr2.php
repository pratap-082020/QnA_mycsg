...
<title>mycsg SASnR2 1300_Subset-variables</title>
...
</script><div class='csg-adwrap' id='sasnr-lesson-wrap'><div class='csg-center-col'><center><h2>Subset variables</h2></center><hr><div class="card mb-3 code-card lang-default">  <div class="card-header p-2 d-flex justify-content-between align-items-center accordion-header lang-default" data-toggle="collapse" data-target="#lessonDesc" style="cursor:pointer;" role="button" aria-expanded="true" aria-controls="lessonDesc">    <h6 class="mb-0">Lesson Description</h6>    <span class="toggle-indicator" data-target="lessonDesc">-</span>  </div>  <div id="lessonDesc" class="collapse show">    <div class="card-body variant-description"><ul>
<li>When a dataset has many columns and we only need a few, we select just those variables &mdash; the column-wise counterpart of row filtering.</li>
<li>SAS offers <code>keep</code> to pick variables and <code>drop</code> to remove them. Both support name lists and colon-prefix patterns like <code>h:</code> for &ldquo;every variable starting with h&rdquo;.</li>
<li>In R, tidyverse uses <code>select()</code> with a rich mini-language: bare names, negative names, <code>starts_with()</code>, <code>ends_with()</code> and friends. Base R uses <code>[, cols]</code> subscripting with names or name patterns.</li>
<li>This lesson shows four common variable-subset tasks on the CLASS dataset: keep specific columns, drop specific columns, drop by prefix pattern, drop by suffix pattern.</li>
<li>After running, we have multiple subset datasets with only the chosen columns.</li>
...
<span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#89632b;background-color:#ffffc0;">Alfred|M|14|69|112.5<br>Alice|F|13|56.5|84<br>Barbara|F|13|65.3|98<br>Carol|F|14|62.8|102.5<br>Henry|M|14|63.5|102.5<br>James|M|12|57.3|83<br></span><span style="color:#000000;background-color:#ffffff;">;;;;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br> <br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*Keep;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br> <br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> subset;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">set</span><span style="color:#000000;background-color:#ffffff;"> class;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">keep</span><span style="color:#000000;background-color:#ffffff;"> Name Sex Age;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br> <br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*drop;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br> <br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> subset;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">set</span><span style="color:#000000;background-color:#ffffff;"> class;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">drop</span><span style="color:#000000;background-color:#ffffff;"> height weight;<br></span>
<b><span style="color:#000080;background-color:#ffffff;">run</span></b>;
<span style="color:#000000;background-color:#ffffff;"><br> <br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*drop - pattern;</span><span style="color:#000000;background-color:#ffffff;"><br></span><span style="color:#1b7a1b;background-color:#ffffff;">*------------------------------------------------------------------------------;</span><span style="color:#000000;background-color:#ffffff;"><br></span><b><span style="color:#000080;background-color:#ffffff;">data</span></b><span style="color:#000000;background-color:#ffffff;"> subset;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">set</span><span style="color:#000000;background-color:#ffffff;"> class;<br></span>
<span style="color:#0000ff;background-color:#ffffff;">drop</span><span style="color:#000000;background-color:#ffffff;"> h: w:;<br></span>
...
<li>To keep specific variables, we add a <code>keep</code> statement inside the DATA step: <code>keep Name Sex Age;</code>.</li>
<li>To drop variables instead, we use <code>drop height weight;</code>. The effect is the opposite &mdash; SAS writes every variable except the listed ones.</li>
<li>For pattern-based dropping, SAS supports the colon shorthand: <code>drop h: w:;</code> drops every variable whose name starts with h or w.</li>
<li>We can mix <code>keep</code> and <code>drop</code> statements or even use dataset-option forms like <code>set class (drop=height weight);</code> when we want the subset to happen at the <code>SET</code> stage.</li>
<li>The output dataset has the same rows as the input but only the selected columns.</li>
...
subset&lt;-select(class,-ends_with(&quot;t&quot;))</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>To keep specific columns in tidyverse, we use <code>select()</code> with the column names: <code>select(class, Name, Sex, Age)</code>.</li>
<li>To drop columns instead, we prefix the names with a minus sign: <code>select(class, -Height, -Weight)</code>. Reads as &ldquo;everything from class except Height and Weight&rdquo;.</li>
<li>For pattern-based selection, <code>select()</code> accepts helper functions: <code>starts_with("H")</code>, <code>ends_with("t")</code>, <code>contains("_")</code>, <code>matches(regex)</code>.</li>
<li>We combine helpers with minus for negative patterns: <code>select(class, -starts_with(c("H", "W")))</code> drops every variable starting with H or W.</li>
<li>This mini-language makes column selection very expressive without the clutter of name lists.</li>
...
subset &lt;- class[, c(&quot;Name&quot;, &quot;Sex&quot;, &quot;Age&quot;)]

subset &lt;- class[, !(names(class) %in% c(&quot;Height&quot;, &quot;Weight&quot;))]

subset &lt;- class[, !grepl(&#039;^(H|W)&#039;, names(class))]

subset &lt;- class[, !grepl(&#039;t$&#039;, names(class))]</code></pre>      </div><div class="variant-description mt-2"><ul>
<li>In base R, we select columns with <code>[, col_spec]</code> subscript &mdash; the same bracket syntax as row subsetting but with the column slot filled in.</li>
<li><code>class[, c("Name", "Sex", "Age")]</code> keeps the listed columns. Names must be quoted.</li>
<li>To drop columns, we combine <code>names()</code>, <code>%in%</code> and the logical-not operator <code>!</code>: <code>class[, !(names(class) %in% c("Height", "Weight"))]</code>.</li>
<li>For pattern-based dropping we use <code>grepl()</code> &mdash; the base R regex matcher: <code>class[, !grepl('^(H|W)', names(class))]</code> drops every column whose name matches the regex.</li>
<li>The same pattern handles suffix drops: <code>!grepl('t$', names(class))</code> drops every column whose name ends in t.</li>
</ul></div>    </div>  </div></div></div></div></div><script>
    const variants = [{"label":"SAS (Base SAS)","code":"\ndata\u00a0CLASS;\ninfile\u00a0datalines\u00a0dlm='|'\u00a0dsd\u00a0missover;\ninput\u00a0Name\u00a0:\u00a0$8.\u00a0Sex\u00a0:\u00a0$1.\u00a0Age\u00a0:\u00a0best32.\u00a0Height\u00a0:\u00a0best32.\u00a0Weight\u00a0:\u00a0best32.;\nlabel\u00a0;\nformat\u00a0;\ndatalines4;\nAlfred|M|14|69|112.5Alice|F|13|56.5|84Barbara|F|13|65.3|98Carol|F|14|62.8|102.5Henry|M|14|63.5|102.5James|M|12|57.3|83;;;;\nrun;\n\u00a0*------------------------------------------------------------------------------;*Keep;*------------------------------------------------------------------------------;\u00a0data\u00a0subset;\nset\u00a0class;\nkeep\u00a0Name\u00a0Sex\u00a0Age;\nrun;\n\u00a0*------------------------------------------------------------------------------;*drop;*------------------------------------------------------------------------------;\u00a0data\u00a0subset;\nset\u00a0class;\ndrop\u00a0height\u00a0weight;\nrun;\n\u00a0*------------------------------------------------------------------------------;*drop\u00a0-\u00a0pattern;*------------------------------------------------------------------------------;data\u00a0subset;\nset\u00a0class;\ndrop\u00a0h:\u00a0w:;\nrun;","language":"sas","html":"<div style=\"font-family: Courier New; font-size: 13pt\">\n<b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0CLASS;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">infile<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">datalines<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dlm<\/span><span style=\"color:#000000;background-color:#ffffff;\">=<\/span><span style=\"color:#800080;background-color:#ffffff;\">'|'<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">dsd<\/span>\u00a0<span style=\"color:#0000ff;background-color:#ffffff;\">missover<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">input<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Name\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">$8.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Sex\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">$1.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Age\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Height\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Weight\u00a0:\u00a0<\/span><span style=\"color:#08726d;background-color:#ffffff;\">best32.<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#0000ff;background-color:#ffffff;\">label<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">format<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">datalines4<\/span>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#89632b;background-color:#ffffc0;\">Alfred|M|14|69|112.5<br>Alice|F|13|56.5|84<br>Barbara|F|13|65.3|98<br>Carol|F|14|62.8|102.5<br>Henry|M|14|63.5|102.5<br>James|M|12|57.3|83<br><\/span><span style=\"color:#000000;background-color:#ffffff;\">;;;;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br>\u00a0<br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*Keep;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br>\u00a0<br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0subset;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">set<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0class;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">keep<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0Name\u00a0Sex\u00a0Age;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br>\u00a0<br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*drop;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br>\u00a0<br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0subset;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">set<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0class;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">drop<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0height\u00a0weight;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b>;\n<span style=\"color:#000000;background-color:#ffffff;\"><br>\u00a0<br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*drop\u00a0-\u00a0pattern;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><span style=\"color:#1b7a1b;background-color:#ffffff;\">*------------------------------------------------------------------------------;<\/span><span style=\"color:#000000;background-color:#ffffff;\"><br><\/span><b><span style=\"color:#000080;background-color:#ffffff;\">data<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">\u00a0subset;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">set<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0class;<br><\/span>\n<span style=\"color:#0000ff;background-color:#ffffff;\">drop<\/span><span style=\"color:#000000;background-color:#ffffff;\">\u00a0h:\u00a0w:;<br><\/span>\n<b><span style=\"color:#000080;background-color:#ffffff;\">run<\/span><\/b><span style=\"color:#000000;background-color:#ffffff;\">;<\/span><\/div>"},{"label":"R (tidyverse)","code":"library(tidyverse)\n\nclass<-tribble(\n  ~Name,~Sex,~Age,~Height,~Weight,\n  \"Alfred\",\"M\",14,69,112.5,\n  \"Alice\",\"F\",13,56.5,84,\n  \"Barbara\",\"F\",13,65.3,98,\n  \"Carol\",\"F\",14,62.8,102.5,\n  \"Henry\",\"M\",14,63.5,102.5,\n  \"James\",\"M\",12,57.3,83,\n)\n\nsubset <- select(class, Name, Sex, Age)\n\n\nsubset <- select(class, -Height, -Weight)\n\nsubset<-select(class,-starts_with(c(\"H\",\"W\")))\n\nsubset<-select(class,-ends_with(\"t\"))","language":"r","html":"<pre><code class=\"language-r\">library(tidyverse)\n\nclass&lt;-tribble(\n  ~Name,~Sex,~Age,~Height,~Weight,\n  &quot;Alfred&quot;,&quot;M&quot;,14,69,112.5,\n  &quot;Alice&quot;,&quot;F&quot;,13,56.5,84,\n  &quot;Barbara&quot;,&quot;F&quot;,13,65.3,98,\n  &quot;Carol&quot;,&quot;F&quot;,14,62.8,102.5,\n  &quot;Henry&quot;,&quot;M&quot;,14,63.5,102.5,\n  &quot;James&quot;,&quot;M&quot;,12,57.3,83,\n)\n\nsubset &lt;- select(class, Name, Sex, Age)\n\n\nsubset &lt;- select(class, -Height, -Weight)\n\nsubset&lt;-select(class,-starts_with(c(&quot;H&quot;,&quot;W&quot;)))\n\nsubset&lt;-select(class,-ends_with(&quot;t&quot;))<\/code><\/pre>"},{"label":"R (base)","code":"class <- data.frame(\n  Name = c(\"Alfred\", \"Alice\", \"Barbara\", \"Carol\", \"Henry\", \"James\"),\n  Sex = c(\"M\", \"F\", \"F\", \"F\", \"M\", \"M\"),\n  Age = c(14, 13, 13, 14, 14, 12),\n  Height = c(69, 56.5, 65.3, 62.8, 63.5, 57.3),\n  Weight = c(112.5, 84, 98, 102.5, 102.5, 83)\n  , stringsAsFactors = FALSE\n)\n\nsubset <- class[, c(\"Name\", \"Sex\", \"Age\")]\n\nsubset <- class[, !(names(class) %in% c(\"Height\", \"Weight\"))]\n\nsubset <- class[, !grepl('^(H|W)', names(class))]\n\nsubset <- class[, !grepl('t$', names(class))]","language":"r","html":"<pre><code class=\"language-r\">class &lt;- data.frame(\n  Name = c(&quot;Alfred&quot;, &quot;Alice&quot;, &quot;Barbara&quot;, &quot;Carol&quot;, &quot;Henry&quot;, &quot;James&quot;),\n  Sex = c(&quot;M&quot;, &quot;F&quot;, &quot;F&quot;, &quot;F&quot;, &quot;M&quot;, &quot;M&quot;),\n  Age = c(14, 13, 13, 14, 14, 12),\n  Height = c(69, 56.5, 65.3, 62.8, 63.5, 57.3),\n  Weight = c(112.5, 84, 98, 102.5, 102.5, 83)\n  , stringsAsFactors = FALSE\n)\n\nsubset &lt;- class[, c(&quot;Name&quot;, &quot;Sex&quot;, &quot;Age&quot;)]\n\nsubset &lt;- class[, !(names(class) %in% c(&quot;Height&quot;, &quot;Weight&quot;))]\n\nsubset &lt;- class[, !grepl(&#039;^(H|W)&#039;, names(class))]\n\nsubset &lt;- class[, !grepl(&#039;t$&#039;, names(class))]<\/code><\/pre>"}] || [];
