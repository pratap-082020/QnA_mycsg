...
<title>mycsg SASnR2 Lessons</title>
...
document.addEventListener('DOMContentLoaded', function() {
  document.querySelectorAll('.csg-ad-col .adsbygoogle').forEach(function(ins) {
    var col = ins.closest('.csg-ad-col');
    if (!col) return;
    function check() {
      var s = ins.getAttribute('data-ad-status');
      if (s === 'filled')   { col.classList.add('is-filled');    return true; }
      if (s === 'unfilled') { col.classList.remove('is-filled'); return true; }
      // Fallback: some AdSense formats (related content, multiplex) do not
      // set data-ad-status. Treat as filled if the <ins> has rendered content.
      if (ins.offsetHeight > 20 || ins.querySelector('iframe')) {
    ...
    obs.observe(ins, { attributes: true, attributeFilter: ['data-ad-status'], childList: true });
    check();
    // Delayed fallbacks for slow-loading ad formats
...
</script><div class='csg-adwrap' id='sasnr-lesson-wrap'><div class='csg-ad-col'>
  <div class='csg-ad-label'>Advertisement</div>
  <ins class='adsbygoogle' style='display:block;width:100%;min-height:600px;' data-ad-client='ca-pub-7309667479757182' data-ad-slot='1745280409' data-ad-format='auto' data-full-width-responsive='true'></ins>
  <script>(adsbygoogle = window.adsbygoogle || []).push({});</script>
</div><div class='csg-center-col'><center><h2>SASnR Lessons</h2></center><table class="table table-striped table-sm"><thead class="thead-dark"><tr><th>Order</th><th>Title</th></tr></thead><tbody><tr><td>0110</td><td><a href="sasnr2.php?lesson=0110_Install an R package">Install an R package</a></td></tr><tr><td>0120</td><td><a href="sasnr2.php?lesson=0120_Load an R package">Load an R package (library)</a></td></tr><tr><td>1000</td><td><a href="sasnr2.php?lesson=1000_Create_Sample_Data">Create Sample Data</a></td></tr><tr><td>1100</td><td><a href="sasnr2.php?lesson=1100_Create_a_copy_of_an_existing_dataset">Create a copy of an existing dataset</a></td></tr><tr><td>1200</td><td><a href="sasnr2.php?lesson=1200_Subset-Observations">Subset Observations</a></td></tr><tr><td>1300</td><td><a href="sasnr2.php?lesson=1300_Subset-variables">Subset variables</a></td></tr><tr><td>1400</td><td><a href="sasnr2.php?lesson=1400_Subset-observations-and-variables">Subset observations and variables</a></td></tr><tr><td>1500</td><td><a href="sasnr2.php?lesson=1500_Renaming-variables">Renaming variables</a></td></tr><tr><td>1501</td><td><a href="sasnr2.php?lesson=1501_validvarname_upcase">Convert all the variable names to uppercase</a></td></tr><tr><td>1600</td><td><a href="sasnr2.php?lesson=1600_Adding-new-variables">Adding new variables</a></td></tr><tr><td>1700</td><td><a href="sasnr2.php?lesson=1700_Appending-datasets">Appending datasets</a></td></tr><tr><td>1800</td><td><a href="sasnr2.php?lesson=1800_Merging-datasets">Merging datasets</a></td></tr><tr><td>1850</td><td><a href="sasnr2.php?lesson=1850_Merging-datasets--select-unmatched-records">Merging datasets- select unmatched records</a></td></tr><tr><td>1860</td><td><a href="sasnr2.php?lesson=1860_Merging-datasets---cartesian-product">Merging datasets - cartesian product</a></td></tr><tr><td>1865</td><td><a href="sasnr2.php?lesson=1865_conditional_logic_case_when_default_missing">conditional logic - case_when - .default and missing values</a></td></tr><tr><td>1870</td><td><a href="sasnr2.php?lesson=1870_conditional_logic_if_else">conditional logic - if_else</a></td></tr><tr><td>1875</td><td><a href="sasnr2.php?lesson=1875_conditional_logic_if_else_nested">conditional logic - if_else - nested conditions</a></td></tr><tr><td>1900</td><td><a href="sasnr2.php?lesson=1900_Sorting-observations">Sorting observations</a></td></tr><tr><td>1901</td><td><a href="sasnr2.php?lesson=1901_Sort_Order_With_Missing_Values">Sort Order with Missing Values</a></td></tr><tr><td>2000</td><td><a href="sasnr2.php?lesson=2000_Fetching-Frequencies">Fetching Frequencies</a></td></tr><tr><td>2100</td><td><a href="sasnr2.php?lesson=2100_Descriptive-statistics-for-numeric-variables">Descriptive statistics for numeric variables</a></td></tr><tr><td>2110</td><td><a href="sasnr2.php?lesson=2110_summary_stats_by_treatment">Summarize Age by Treatment Group with Descriptive Statistics</a></td></tr><tr><td>2200</td><td><a href="sasnr2.php?lesson=2200_First-dot-concept">First dot concept</a></td></tr><tr><td>2210</td><td><a href="sasnr2.php?lesson=2210_Last-dot-concept">Last dot concept</a></td></tr><tr><td>2220</td><td><a href="sasnr2.php?lesson=2220_First-dot-and-last-dot-concept">First dot and last dot concept</a></td></tr><tr><td>2300</td><td><a href="sasnr2.php?lesson=2300_Handling-duplicates">Handling duplicates</a></td></tr><tr><td>2400</td><td><a href="sasnr2.php?lesson=2400_Transpose-data---long-to-wide">Transpose data - long to wide</a></td></tr><tr><td>2500</td><td><a href="sasnr2.php?lesson=2500_Transpose-data---wide-to-long">Transpose data - wide to long</a></td></tr><tr><td>2600</td><td><a href="sasnr2.php?lesson=2600_Arrays-repeat-same-logic-on-multiple-variables">Arrays-repeat same logic on multiple variables</a></td></tr><tr><td>2610</td><td><a href="sasnr2.php?lesson=2610_Arrays---Example---replace-a-text-value-in-all-character-variables">Arrays - Example - replace a text value in all character variables</a></td></tr><tr><td>2611</td><td><a href="sasnr2.php?lesson=2611_Arrays---Example---replace-a-value-in-all-numeric-variables">Arrays - Example - replace a value in all numeric variables</a></td></tr><tr><td>2612</td><td><a href="sasnr2.php?lesson=2612_Arrays---Example---replace-a-value-in-all-numeric-and-character-variables">Arrays - Example - replace a value in all numeric and character variables</a></td></tr><tr><td>2700</td><td><a href="sasnr2.php?lesson=2700_Retain_first_value_of_subject_onto_other_records">Retain first value of a subject onto other records</a></td></tr><tr><td>2701</td><td><a href="sasnr2.php?lesson=2701_Retain_last_non_missing_value">Retain last non-missing value</a></td></tr><tr><td>2702</td><td><a href="sasnr2.php?lesson=2702_Retain_minimum_score_upto_current_observation">Retain minimum score upto the current observation</a></td></tr><tr><td>2703</td><td><a href="sasnr2.php?lesson=2703_Retain_maximum_score_upto_current_observation">Retain maximum score upto the current observation</a></td></tr><tr><td>2705</td><td><a href="sasnr2.php?lesson=2705_Retain_Concatenate_character_results_into_a_single_value">Retain - Concatenate character results into a single value in a group</a></td></tr><tr><td>2810</td><td><a href="sasnr2.php?lesson=2810_Replicating_usage_of_loops_for_dummy_creation">Replicating the concept of usage of loops for dummy data creation</a></td></tr><tr><td>2900</td><td><a href="sasnr2.php?lesson=2900_proc_format_named_vector">Replicate PROC FORMAT Using Named Vectors in R</a></td></tr><tr><td>3001</td><td><a href="sasnr2.php?lesson=3001_read_sas_files_using_path">Reading Files Using Path References</a></td></tr><tr><td>3100</td><td><a href="sasnr2.php?lesson=3100_Character_functions">Character Functions</a></td></tr><tr><td>3105</td><td><a href="sasnr2.php?lesson=3105_compress-or-remove-specific-characters">Compress or remove specific characters</a></td></tr><tr><td>3190</td><td><a href="sasnr2.php?lesson=3190_count_missing_selected_vars">Count Missing Values in Selected Variables</a></td></tr><tr><td>3191</td><td><a href="sasnr2.php?lesson=3191_character_numeric_conversion">Convert Between Character and Numeric Variables</a></td></tr><tr><td>3193</td><td><a href="sasnr2.php?lesson=3193_keep_nonmissing_columns">Keep Only Variables with Non-missing Values Across Dataset</a></td></tr><tr><td>3201</td><td><a href="sasnr2.php?lesson=3201_Apply_Basic_Numeric_Functions">Apply Basic Numeric Functions</a></td></tr><tr><td>3210</td><td><a href="sasnr2.php?lesson=3210_rounding_values">Round Numeric Values</a></td></tr><tr><td>3214</td><td><a href="sasnr2.php?lesson=3214_cumulative_operations">Cumulative Sum, Mean, and Product</a></td></tr><tr><td>3304</td><td><a href="sasnr2.php?lesson=3304_extract_date_parts">Extract Day, Month, Year, Weekday from Date</a></td></tr><tr><td>3407</td><td><a href="sasnr2.php?lesson=3407_rowwise_max_from_multiple_columns">Find Maximum Value Across Multiple Variables in Each Row</a></td></tr><tr><td>3601</td><td><a href="sasnr2.php?lesson=3601_Apply_attributes_to_variables">Apply attributes to variables</a></td></tr><tr><td>3710</td><td><a href="sasnr2.php?lesson=3710_mimicking-the-behavior-of-proc-contents">Mimicking the behavior of PROC CONTENTS</a></td></tr><tr><td>3800</td><td><a href="sasnr2.php?lesson=3800_compare-datasets">Compare datasets</a></td></tr><tr><td>4010</td><td><a href="sasnr2.php?lesson=4010_import_excel_workbooks_csv">Import data from Excel workbooks - CSV</a></td></tr><tr><td>4015</td><td><a href="sasnr2.php?lesson=4015_import_excel_workbooks_xlsx">Import data from Excel workbooks - XLSX</a></td></tr><tr><td>4020</td><td><a href="sasnr2.php?lesson=4020_import_excel_workbooks_xls">Import data from Excel workbooks - XLS</a></td></tr><tr><td>4025</td><td><a href="sasnr2.php?lesson=4025_export_data_to_excel_workbook">Export data to Excel workbook</a></td></tr><tr><td>5100</td><td><a href="sasnr2.php?lesson=5100_mimicking_macro_variable_creation_and_usage">Create a macro variable and use it in open code</a></td></tr><tr><td>5103</td><td><a href="sasnr2.php?lesson=5103_mimicking_macro_variable_creation_and_usage_list_of_values">Create a macro variable to store list of values and use it in open code</a></td></tr><tr><td>8100</td><td><a href="sasnr2.php?lesson=8100_list_files_in_directory">Get the list the files in a Directory/Folder to a dataset</a></td></tr><tr><td>8110</td><td><a href="sasnr2.php?lesson=8110_list_files_with_metadata">List Files with Metadata: Size, Created and Modified Time</a></td></tr><tr><td>9105</td><td><a href="sasnr2.php?lesson=9105_Detach an R package">Detach an R package (unload from session)</a></td></tr><tr><td>9120</td><td><a href="sasnr2.php?lesson=9120_Remove objects from environment">Remove objects from the environment (rm / remove)</a></td></tr><tr><td>9310</td><td><a href="sasnr2.php?lesson=9310_read-or-load-multiple-xpt-files-or-sas-datasets-simultaneously-into-r">Read or load multiple xpt files or sas datasets simultaneously into R</a></td></tr><tr><td>9550</td><td><a href="sasnr2.php?lesson=9550_run-multiple-programs-for-a-single-file">Run multiple programs from a single file</a></td></tr></tbody></table></div><div class='csg-ad-col'>
  <div class='csg-ad-label'>Advertisement</div>
  <ins class='adsbygoogle' style='display:block;width:100%;min-height:600px;' data-ad-client='ca-pub-7309667479757182' data-ad-slot='1745280409' data-ad-format='auto' data-full-width-responsive='true'></ins>
  <script>(adsbygoogle = window.adsbygoogle || []).push({});</script>
</div></div>
