...
#==============================================================================;
adeg03 <- bind_rows(
 adeg02 %>% filter(crit2!="") %>% mutate(severity=2, severityc=crit2),
 adeg02 %>% filter(crit3!="") %>% mutate(severity=3, severityc=crit3),
 adeg02 %>% filter(crit4!="") %>% mutate(severity=4, severityc=crit4),
)
...
#==============================================================================;
dummy02 <- dummy01 %>%
 cross_join(expand_grid(treatment = 1:3, severity = 1:4))
