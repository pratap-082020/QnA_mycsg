...
ncount <- adeg02 %>%
 ...
 summarize(avalca1n = 1, count = n_distinct(usubjid))
 
#==============================================================================;
# Get counts for different levels;
#==============================================================================;
levelscount <- adeg02 %>%
 group_by(paramn, paramcd, param, avisitn, avisit, avalca1n, treatment) %>%
...
#==============================================================================;
# Create a record for each treatment and avalca1n level using do loops;
#==============================================================================;
dummy02 <- dummy01 %>%
 cross_join(expand_grid(treatment = 1:3, avalca1n = 1:5))
 
#==============================================================================;
# Merge dummy and actual counts;
#==============================================================================;
counts02 <- dummy02 %>%
 left_join(counts01, by = c("paramn", "paramcd", "param", "avisitn", "avisit", "treatment", "avalca1n")) %>%
...
#==============================================================================;
trans01 <- counts04 %>%
 pivot_wider(id_cols=c(paramn,paramcd,param,avisitn,avisit, avalca1n, label),
...
output <- trans01 %>%
 arrange(paramn,avisitn,avalca1n)
