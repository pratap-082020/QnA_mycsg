...
=========================================================*/
%let root2=&root.ADaM\ADaM_C1003\ADaM_C1003_L102a\ADaM_C1003_L102a;
...
data ae04;
   ...
   if trtsdt ne . then do;
      if astdt ge trtsdt gt . and . lt astdt le trtedt+15 then do;
...
=========================================================*/
data output;
   retain usubjid aedecod trtsdt astdt trtedt aesev trtemfl aendt aestdtc aeendtc basesev;
   set ae04;
   keep usubjid aedecod astdt aendt trtemfl trtsdt aestdtc trtedt aeendtc aesev basesev;
run;
