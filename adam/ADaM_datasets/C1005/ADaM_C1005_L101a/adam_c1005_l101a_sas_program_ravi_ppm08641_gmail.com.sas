...
=========================================================*/
%let root2=&root.ADaM\ADaM_C1005\ADaM_C1005_L101a\ADaM_C1005_L101a;
...
/*----------------------------------------------------------
Identify the record with maximum result across postbaseline rows and append it back to full data
----------------------------------------------------------*/
