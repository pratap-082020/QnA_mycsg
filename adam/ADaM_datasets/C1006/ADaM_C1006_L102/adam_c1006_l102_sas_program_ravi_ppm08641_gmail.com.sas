...
=========================================================*/
%let root2=&root.ADaM\ADaM_C1006\ADaM_C1006_L102\ADaM_C1006_L102;
...
Create ABLFL variable by assiging a value of "Y" on the record with minimum result
If there exists more than one record with the minium value pick the latest record
----------------------------------------------------------*/

proc sort data=vs02 out=base01;
   by usubjid paramn descending aval adt visitnum;
...
=========================================================*/
data output;
   retain usubjid basetype paramn paramcd param adt avisitn avisit aval base chg pchg trtsdt ablfl;
   set vs05;
