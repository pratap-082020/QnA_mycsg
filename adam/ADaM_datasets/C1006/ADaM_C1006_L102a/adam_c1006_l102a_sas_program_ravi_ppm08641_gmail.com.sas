...
=========================================================*/
%let root2=&root.ADaM\ADaM_C1006\ADaM_C1006_L102a\ADaM_C1006_L102a;
...
Create ABLFL variable by assiging a value of "Y" on the record with maximum result
If there exists more than one record with the maximum value pick the latest record
----------------------------------------------------------*/
