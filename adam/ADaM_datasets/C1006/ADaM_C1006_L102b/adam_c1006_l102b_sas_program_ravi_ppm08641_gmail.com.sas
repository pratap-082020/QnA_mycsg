...
=========================================================*/
%let root2=&root.ADaM\ADaM_C1006\ADaM_C1006_L102b\ADaM_C1006_L102b;
...
data output;
   ...
   set vs05;
   keep usubjid paramn paramcd param adt  avisitn avisit aval base chg pchg trtsdt ablfl basetype;
run;
