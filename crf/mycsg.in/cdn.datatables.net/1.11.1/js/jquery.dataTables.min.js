...
(function(l) {
        ...
        if ("dom" !== c && (c && "auto" !== c || "dom" !== e.src)) {
            ...
            if (f)
                if (d !== q) g(f[d], d);
                    ...
                    for (c = 0, h = f.length; c < h; c++) g(f[c], c)
    ...
    function Eb(a) {
        ...
        if (null !== e)
            for (a = a.aoFooter[0], k = 0, b = a.length; k < b; k++) n = f[k], n.nTf = a[k].cell, n.sClass && l(n.nTf).addClass(n.sClass)
    }
        ...
        if (-1 !== l.inArray(!1, c)) V(a, !1);
            ...
            if (0 !== n.length)
                for (b = k ? a.aoData.length : m, g = k ? 0 : f; g < b; g++) {
                    ...
                    c.push(t);
                    d++
                } else d = g.sZeroRecords, 1 == a.iDraw && "ajax" == Q(a) ? d = g.sLoadingRecords : g.sEmptyTable && 0 === a.fnRecordsTotal() && (d = g.sEmptyTable), c[0] = l("<tr/>", {
                    "class": h ? e[0] : ""
                }).append(l("<td />", {
                    valign: "top",
                    colSpan: oa(a),
        ...
        for (var h = a.sDom.split(""), g, f, k, n, m, p, t = 0; t < h.length; t++) {
            ...
            if ("<" == f) {
                ...
                if ("'" == n || '"' == n) {
                    ...
                    "H" == m ? m = b.sJUIHeader : "F" == m && (m = b.sJUIFooter); - 1 != m.indexOf(".") ? (n = m.split("."), k.id = n[0].substr(1, n[0].length - 1), k.className = n[1]) : "#" == m.charAt(0) ? k.id = m.substr(1, m.length - 1) : k.className = m;
                    t += p
                }
                e.append(k);
                e = l(k)
    ...
    function Oa(a, b, c) {
        ...
        n = {
            ...
            error: function(m, p, t) {
                t = F(a, null, "xhr", [a, null, a.jqXHR]); - 1 === l.inArray(!0, t) && ("parsererror" == p ? da(a, 0, "Invalid JSON response", 1) : 4 === m.readyState && da(a, 0, "Ajax error", 7));
                V(a, !1)
            }
        };
        a.oAjaxData = b;
        ...
        }), f, a) : a.sAjaxSource || "string" === typeof h ? a.jqXHR = l.ajax(l.extend(n, {
            url: h || a.sAjaxSource
        })) : "function" === typeof h ? a.jqXHR = h.call(g, b, f, a) : (a.jqXHR = l.ajax(l.extend(n, h)), h.data = k)
    }
    ...
    function Lb(a) {
        ...
        k = l("<div/>", {
            ...
            0).append("top" === f ? g : null).append(b.children("thead"))))).append(l("<div/>", {
            "class": h.sScrollBody
        }).css({
            position: "relative",
            overflow: "auto",
        ...
        }).append(n.removeAttr("id").css("margin-left", 0).append("bottom" === f ? g : null).append(b.children("tfoot")))));
        b = k.children();
        var p = b[0];
        h = b[1];
        var t = m ? b[2] : null;
    ...
    function Ya(a) {
        ...
        if (d || !t && !h && !e && f == oa(a) && f == n.length)
            for (v = 0; v < f; v++) k = ua(a, v), null !== k && (c[k].sWidth = K(n.eq(v).width()));
        else {
        ...
        b = function(f) {
            if (f && f.time) {
                ...
                if (-1 === l.inArray(!1, k) && (k = a.iStateDuration, !(0 < k && f.time < +new Date - 1E3 * k || f.columns && h.length !== f.columns.length))) {
                    ...
                    if (f.columns)
                        for (d = 0, e = f.columns.length; d < e; d++) k = f.columns[d], k.visible !== q && (h[d].bVisible = k.visible), k.search !== q && l.extend(a.aoPreSearchCols[d], Vb(k.search));
    ...
    var u = function(a, b) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) da(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    g = r.asStripeClasses;
                    var aa = t.children("tbody").find("tr").eq(0); - 1 !== l.inArray(!0, l.map(g, function(I, H) {
        ...
        kc = function(a, b) {
            if (Array.isArray(b))
                for (var c = 0; c < b.length; c++) kc(a, b[c]);
            else a.push(b);
            return a
        };
            ...
            var b = function(c, d, e) {
                ...
                for (var g, f, k = 0, n = e.length - 1; k < n; k++) {
                    ...
                    if (g) {
                        ...
                        g = h.join(".");
                        if (Array.isArray(d))
                            for (f = 0, n = d.length; f < n; f++) h = {}, b(h, d[f], g), c[e[k]].push(h);
                        else c[e[k]] = d;
                        return
                    }
    ...
    var tb = function(a, b, c, d, e) {
            ...
            a = M.selector[a];
            if (a.length)
                for (n = 0, f = a.length; n < f; n++) h = a[n](d, e, h);
            return Ma(h)
        },
        ub = function(a) {
            a || (a = {});
        ...
        Va = function(a, b) {
            ...
            if ("current" == b)
                ...
                for (g = 0, a = a.aoData.length; g < a; g++) "none" == h ? c.push(g) : (e = l.inArray(g, d), (-1 === e && "removed" == h || 0 <= e && "applied" == h) && c.push(g));
            return c
        },
        vc = function(a, b, c) {
            var d;
    ...
    var wc = function(a, b, c, d) {
            var e = [],
                h = function(g, f) {
                    ...
                    else g.nodeName && "tr" === g.nodeName.toLowerCase() ? e.push(g) : (k = l("<tr><td></td></tr>").addClass(f), l("td", k).addClass(f).html(g)[0].colSpan =
                        oa(a), e.push(k[0]))
                };
            h(c, d);
        ...
        xc = function(a) {
            ...
            0 < U(c, "_details").length && (b.on("draw.dt.DT_details", function(d, e) {
                ...
                if (a === e)
                    for (e = oa(e), h = 0, g = c.length; h < g; h++) d =
    ...
    y("cells()", function(a, b, c) {
        ...
        d = this.iterator("table", function(m, p) {
            ...
            for (f = h[p].length; g < f; g++)
                for (k = 0, n = e[p].length; k < n; k++) m.push({
                    row: h[p][g],
                    column: e[p][k]
                });
            return m
