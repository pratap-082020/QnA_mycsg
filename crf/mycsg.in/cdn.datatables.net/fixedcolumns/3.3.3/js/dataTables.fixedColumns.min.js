...
(function(d) {
    ...
    }) : "object" === typeof exports ? module.exports = function(v, w) {
        v || (v = window);
    ...
    var y = d.fn.dataTable,
        B, q = function(a, b) {
            ...
            if (this instanceof q) {
                ...
                f && (f(q.defaults, q.defaults, !0), f(q.defaults,
                    b));
    ...
    d.extend(q.prototype, {
        ...
        fnToFixedNode: function(a, b) {
            var c;
            b < this.s.iLeftColumns ? c = d(this.dom.clone.left.body).find("[data-dt-row=" + a + "][data-dt-column=" +
                b + "]") : b >= this.s.iRightColumns && (c = d(this.dom.clone.right.body).find("[data-dt-row=" + a + "][data-dt-column=" + b + "]"));
            return c && c.length ? c[0] : (new d.fn.dataTable.Api(this.s.dt)).cell(a, b).node()
        },
        _fnConstruct: function(a) {
            var b = this;
            if ("function" != typeof this.s.dt.oInstance.fnVersionCheck || !0 !== this.s.dt.oInstance.fnVersionCheck("1.8.0")) alert("FixedColumns " + q.VERSION + " required DataTables 1.8.0 or later. Please upgrade your DataTables installation");
                ...
                d(this.dom.scroller).on("mouseover.DTFC touchstart.DTFC", function() {
                    ...
                    if ("main" === c || "key" === c) 0 < b.s.iLeftColumns && (b.dom.grid.left.liner.scrollTop = b.dom.scroller.scrollTop), 0 < b.s.iRightColumns && (b.dom.grid.right.liner.scrollTop = b.dom.scroller.scrollTop)
                });
                var e = "onwheel" in w.createElement("div") ? "wheel.DTFC" : "mousewheel.DTFC";
                0 < b.s.iLeftColumns && (d(b.dom.grid.left.liner).on("mouseover.DTFC touchstart.DTFC",
                    function() {
                        f || "key" === c || (c = "left")
                    }).on("scroll.DTFC", function(g) {
                    ...
                    c = "left";
                    b.dom.scroller.scrollLeft -= "wheel" === g.type ? -g.originalEvent.deltaX : g.originalEvent.wheelDeltaX
                }), d(b.dom.grid.left.head).on("mouseover.DTFC touchstart.DTFC", function() {
                    c = "main"
                }));
                0 < b.s.iRightColumns && (d(b.dom.grid.right.liner).on("mouseover.DTFC touchstart.DTFC",
                    function() {
                        f || "key" === c || (c = "right")
                    }).on("scroll.DTFC", function(g) {
                    ...
                    c = "right";
                    b.dom.scroller.scrollLeft -= "wheel" === g.type ? -g.originalEvent.deltaX : g.originalEvent.wheelDeltaX
                }), d(b.dom.grid.right.head).on("mouseover.DTFC touchstart.DTFC", function() {
                    c = "main"
                }));
                ...
                k.on("draw.dt.DTFC", function() {
                    ...
                    b.dom.grid.left.body && d(b.dom.grid.left.body).find("table").eq(0).css("top",
                        m);
                    b.dom.grid.right.body && d(b.dom.grid.right.body).find("table").eq(0).css("top", m)
            ...
            d.each(this.s.dt.aoColumns, function(f, e) {
                ...
                if (e.filter(":visible").length) {
                    ...
                    if (0 === a.s.aiOuterWidths.length) {
                        ...
                        h += "string" === typeof k && -1 === k.indexOf("px") ? 1 : parseInt(k, 10)
                    }
                    a.s.aiOuterWidths.length === a.s.dt.aoColumns.length - 1 && (k = d(a.s.dt.nTable).css("border-right-width"), h += "string" === typeof k && -1 === k.indexOf("px") ? 1 : parseInt(k, 10));
        ...
        _fnGridSetup: function() {
            ...
            this.s.dt.nTFoot && (this.dom.footer = this.s.dt.nTFoot.parentNode, 0 < this.s.iLeftColumns && (this.dom.grid.left.foot = c.childNodes[2]), 0 < this.s.iRightColumns && (this.dom.grid.right.foot =
                f.childNodes[2]));
            this.s.rtl && d("div.DTFC_RightHeadBlocker", b).css({
                left: -a.bar + "px",
                right: ""
            })
        },
        _fnGridLayout: function() {
            ...
            0 < this.s.iLeftColumns && (f = b.left.wrapper, f.style.width = h + "px", f.style.height = "1px", g ? (f.style.left = "", f.style.right = 0) : (f.style.left = 0, f.style.right = ""), b.left.body.style.height = c + "px", b.left.foot && (b.left.foot.style.top = (e.x ? e.bar : 0) + "px"), m(b.left.liner, h), b.left.liner.style.height = c + "px", b.left.liner.style.maxHeight = c + "px");
            0 < this.s.iRightColumns && (f = b.right.wrapper, f.style.width =
        ...
        _fnCloneRight: function(a) {
            if (!(0 >= this.s.iRightColumns)) {
                var b, c = [];
                for (b = this.s.iTableColumns -
                    this.s.iRightColumns; b < this.s.iTableColumns; b++) this.s.dt.aoColumns[b].bVisible && c.push(b);
        ...
        _fnCopyLayout: function(a, b, c) {
            for (var f = [], e = [], h = [], k = 0, g = a.length; k < g; k++) {
                ...
                for (var l = 0, n = this.s.iTableColumns; l <
                    n; l++)
                    if (-1 !== d.inArray(l, b)) {
                        var r = d.inArray(a[k][l].cell, h); - 1 === r ? (r = d(a[k][l].cell).clone(c, !1)[0], e.push(r), h.push(a[k][l].cell), m.push({
                            cell: r,
                            unique: a[k][l].unique
                        })) : m.push({
                            cell: e[r],
        ...
        _fnClone: function(a, b, c, f) {
            ...
            if (f) {
                ...
                for (h = m.length; n < h; n++) {
                    var t = 0;
                    for (l = m[n].length; t < l; t++) r[n][t].cell.className = m[n][t].cell.className, d("span.DataTables_sort_icon", r[n][t].cell).each(function() {
                        this.className = d("span.DataTables_sort_icon", m[n][t].cell)[0].className
                    })
                }
            }
            this._fnEqualiseHeights("thead", this.dom.header,
                a.header);
            "auto" == this.s.sHeightMatch && d(">tbody>tr", e.dom.body).css("height", "auto");
            ...
            if (0 < g.aiDisplay.length) {
                ...
                d(">tbody>tr", e.dom.body).each(function(u) {
                    u = !1 === e.s.dt.oFeatures.bServerSide ? e.s.dt.aiDisplay[e.s.dt._iDisplayStart + u] : u;
                    var D = e.s.dt.aoData[u].anCells || d(this).children("td, th"),
                        A = this.cloneNode(!1);
                    A.removeAttribute("id");
                    A.setAttribute("data-dt-row",
                        u);
                    for (k = 0; k < c.length; k++) x = c[k], 0 < D.length && (p = d(D[x]).clone(!0, !0)[0], p.removeAttribute("id"), p.setAttribute("data-dt-row", u), p.setAttribute("data-dt-column", x), A.appendChild(p));
                    C.appendChild(A)
                })
            } else d(">tbody>tr", e.dom.body).each(function(u) {
                p = this.cloneNode(!0);
            ...
            g.oScroller !== z && (h = g.oScroller.dom.force, b.forcer ? b.forcer.style.height = h.style.height : (b.forcer =
                h.cloneNode(!0), b.liner.appendChild(b.forcer)));
            ...
            if (null !== g.nTFoot) {
                if (f) {
                    ...
                    for (m =
                        this._fnCopyLayout(g.aoFooter, c, !1), b = [], g.oApi._fnDetectHeader(b, d(">tfoot", a.footer)[0]), n = 0, h = m.length; n < h; n++)
                        for (t = 0, l = m[n].length; t < l; t++) b[n][t].cell.className = m[n][t].cell.className;
            ...
            null !== e.s.dt.nTFoot && (b = g.oApi._fnGetUniqueThs(g, d(">tfoot", a.footer)[0]), d(b).each(function(u) {
                x = c[u];
                this.style.width = e.s.aiInnerWidths[x] +
                    "px"
            }))
        },
        ...
        _fnEqualiseHeights: function(a, b, c) {
            if ("none" != this.s.sHeightMatch || "thead" === a || "tfoot" === a) {
                ...
                c = 0;
                for (a = b.length; c < a; c++) b[c].style.height = e[c] + "px", f[c].style.height = e[c] + "px"
            }
        },
        _firefoxScrollError: function() {
            if (B === z) {
                ...
                B = a[0].clientWidth === a[0].offsetWidth && 0 !== this._fnDTOverflow().bar;
                a.remove()
            }
            return B
        }
    ...
    y.Api.register("fixedColumns().cellIndex()", function(a) {
        ...
        if (a.parents(".DTFC_Cloned").length) {
            ...
            return {
                row: b,
                column: this.column.index("toData",
                    a),
                columnVisible: a
            }
        }
    ...
    y.Api.registerPlural("cells().fixedNodes()", "cell().fixedNode()", function() {
