...
dd_death<-tribble(
~project,~subject,~folderseq,~foldername,~recordposition,~dddat,~autopsy,~prmcaus,~prmcaussp,~seccaus,
"MYCSG","3010",910,"Death details",0,"08/MAR/2010","Yes","Other","Sudden cardiac death","Vascular rupture",
)
